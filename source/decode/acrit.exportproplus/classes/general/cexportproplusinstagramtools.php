...
class CAcritExportproplusInstagramTools{
    public $profile = null;
    public $log = null;
    ...
    public function __construct( $profile ){
        ...
        $this->obInstagramModel = new CAcritExportproplusInstagram( $this->profile );
    ...
    public function SavePost( $arData ){
        ...
        if( $instagramPostId ){
            ...
            if( isset( $arUpdatedPost["status"] ) && ( $arUpdatedPost["status"] != "ok" ) ){
                $this->log->AddMessage( "{$arData["NAME"]} (ID:{$arData["ID"]}) : ".str_replace( "#INSTAGRAM_ERROR#", "CODE: Instagram fail", GetMessage( "ACRIT_EXPORTPROPLUS_REQUIRED_FIELD_INSTAGRAM_SKIP" ) ) );
