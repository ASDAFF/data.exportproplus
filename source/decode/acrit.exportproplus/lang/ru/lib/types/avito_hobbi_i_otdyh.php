<?
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_NAME"] = "Экспорт в систему авито (Хобби и отдых)";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_ID"] = "Уникальный идентификатор объявления<br/>(строка не более 100 символов)<br/><b class='required'>Обязательный элемент</b>";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_DATEBEGIN"] = "Дата начала экспозиции объявления";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_DATEEND"] = "Дата конца экспозиции объявления";

$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_LISTINGFEE"] = "Вариант платного размещения — одно из значений списка:<br/><br/>Package — размещение объявления осуществляется только при наличии подходящего пакета размещения;<br/>PackageSingle — при наличии подходящего пакета оплата размещения объявления произойдет с него; если нет подходящего пакета, но достаточно денег на кошельке Avito, то произойдет разовое размещение;<br/>Single — только разовое размещение, произойдет при наличии достаточной суммы на кошельке Avito; если есть подходящий пакет размещения, он будет проигнорирован.<br/>Если элемент пуст или отсутствует, то значение по умолчанию — Package.";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_ADSTATUS"] = "Платная услуга, которую нужно применить к объявлению — одно из значений списка:<br/><br/>Free — обычное объявление;<br/>Premium — премиум-объявление;<br/>VIP — VIP-объявление;<br/>PushUp — поднятие объявления в поиске;<br/>Highlight — выделение объявления;<br/>TurboSale— применение пакета Турбо-продажа;<br/>QuickSale — применение пакета Быстрая продажа.";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_AVITOID"] = "Номер объявления на Avito — целое число.<br/>Если вы разместили объявление вручную, а теперь хотите управлять объявлением с помощью Автозагрузки — укажите здесь номер объявления на сайте Авито.";

$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_ALLOWEMAIL"] = "Возможность написать сообщение по объявлению через сайт — одно из значений списка: Да, Нет. Примечание: значение по умолчанию — Да.";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_MANAGERNAME"] = "Имя менеджера, контактного лица компании по данному объявлению — строка не более 40 символов.";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_CONTACTPHONE"] = "Контактный телефон — строка, содержащая только один российский номер телефона; должен быть обязательно указан код города или мобильного оператора. Корректные примеры:<br/>+7 (495) 777-10-66,<br/>(81374) 4-55-75,<br/>8 905 207 04 90,<br/>+7 905 2070490,<br/>88123855085,<br/>9052070490.";

$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_REGION"] = "Регион,<br/>в котором находится объект объявления<br/>в соответствии со значениями из справочника.<br/><b class='required'>Обязательный элемент</b>";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_CITY"] = "Город или населенный пункт, в котором находится объект объявления — в соответствии со значениями из справочника.<br/>
...
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_SUBWAY"] = "Ближайшая станция метро<br/>(в соответствии со значениями из справочника)";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_DISTRICT"] = "Район города — в соответствии со значениями из справочника.";

$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_CATEGORY"] = "Категория товара — одно из значений списка:<br/><br/>
...
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_GOODSTYPE"] = "Вид товара — одно из значений списка (отдельно для каждой категории):<br/><br/>
Билеты и путешествия:<br/>
Карты, купоны<br/>
Концерты<br/>
Путешествия<br/>
...
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_VEHICLETYPE"] = "Вид велосипеда – одно из значений списка:<br/><br/>
Горные<br/>
Дорожные<br/>
BMX<br/>
Детские<br/>
...
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_ADTYPE"] = "Вид объявления – одно из значений списка:<br/><br/>
Товар приобретен на продажу<br/>
Товар от производителя.";

$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_TITLE"] = "Название объявления — строка до 50 символов.";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_DESCRIPTION"] = "Текстовое описание объявления в соответствии с правилами Avito — строка не более 3000 символов.";

$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_PRICE"] = "Цена в рублях";
$MESS["ACRIT_EXPORTPROPLUS_AVITO_HOBBI_I_OTDYH_FIELD_IMAGE"] = "Изображения";
$MESS["ACRIT_EXPORTPROPLUS_TYPE_AVITO_HOBBI_I_OTDYH_PORTAL_REQUIREMENTS"] = "http://autoload.avito.ru/format/hobbi_i_otdyh/";
$MESS["ACRIT_EXPORTPROPLUS_TYPE_AVITO_HOBBI_I_OTDYH_PORTAL_VALIDATOR"] = "http://autoload.avito.ru/format/xmlcheck/";
$MESS["ACRIT_EXPORTPROPLUS_TYPE_AVITO_HOBBI_I_OTDYH_EXAMPLE"] = "
