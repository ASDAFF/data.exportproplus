...
class CExportproplusMarketPromuaDB{
    private $tableName = "acrit_exportproplus_market_promua";
    ...
    public function GetMarketList( $marketId ){
        ...
        if( is_array( $marketTiuCategory ) && !empty( $marketTiuCategory ) ){
            ...
            array_walk( $arMarketCategory, "CAcritExportproplusStringProcess::AcritArrayTrimFunc" );
        }
