...
function run_express_agent(){
    ...
    if( CAcritExportproplusTools::ArrayValidate( $arProfile["SETUP"]["CRON"] ) ){
...
function UpdateMarketCategories(){
    ...
    $result = CAcritExportproplusMarketCategories::Process();
...
function unlock_export(){
    global $APPLICATION, $profileID;
    if( file_exists( $_SERVER["DOCUMENT_ROOT"]."/bitrix/tools/acrit.exportproplus/export_{$profileID}_run.lock" ) ){
        require_once( $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/main/include/prolog_admin_before.php" );
        unlink( $_SERVER["DOCUMENT_ROOT"]."/bitrix/tools/acrit.exportproplus/export_{$profileID}_run.lock" );
        file_put_contents( $_SERVER["DOCUMENT_ROOT"]."/bitrix/tools/acrit.exportproplus/export_{$profileID}_run.unlock", "" );
...
function clear_export_data(){
    ...
    CAcritExportproplusTools::ClearExportSession( $profileID );
...
function update_log(){
    ...
    if( file_exists( $_SERVER["DOCUMENT_ROOT"].$arProfile["LOG"]["FILE"] ) ){?>
        <td width="50%" class="adm-detail-content-cell-l" style="padding: 15px 0;">
            <b><?=GetMessage( "ACRIT_EXPORTPROPLUS_LOG_FILE" )?></b>
        </td>
...
function get_condition_block(){
    ...
    CAcritExportproplusProps::$arIBlockFilter = $obProfileUtils->PrepareIBlock( $PROFILE["IBLOCK_ID"], $PROFILE["USE_SKU"] );
        ...
        <?foreach( $categories as $cat ){
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="field-edit" onclick="ShowMarketCategoryList( <?=$cat["ID"]?> )" style="cursor: pointer; background: #9ec710 !important;" title="<?=GetMessage( "ACRIT_EXPORTPROPLUS_MARKET_CATEGORY_DATA_SELECT_SECTION" );?>"></span>
                </td>
            </tr>
        <?}?>
    </table>
...
function calcSteps(){
    ...
    $dbProfile = new CExportproplusProfileDB();
    $arProfile = $dbProfile->GetById( $profileId );
    $elementsObj = new CAcritExportproplusElement( $arProfile );
...
function okDeleteSyncMediatopics(){
    ...
    $dbProfile = new CExportproplusProfileDB();
    $arProfile = $dbProfile->GetById( $profileId );
    $obOkTools = new CAcritExportproplusOkTools( $arProfile );
...
function fieldset_add(){
    ...
    <tr class="fieldset-item" data-id="<?=$id?>">
        <td>
            ...
            <input type="text" name="PROFILE[XMLDATA][<?=$id?>][NAME]" placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_NAME_DESCR" )?>"/>
        </td>
        <td colspan="2">
            <input type="text" name="PROFILE[XMLDATA][<?=$id?>][CODE]" placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_NAME" )?>"/>
            ...
            <input class="field-block" readonly="readonly" name="PROFILE[XMLDATA][<?=$id?>][VALUE_SHOW]" data-id="<?=$id?>" type="text" title="<?=$arLinearFieldsList[$field["VALUE"]];?>" value="<?=( isset( $arLinearFieldsList[$field["VALUE"]] ) ? $arLinearFieldsList[$field["VALUE"]] : GetMessage( "ACRIT_EXPORTPROPLUS_NE_VYBRANO" ) );?>" />
            <span class="field-edit fieldselecter" onclick="ShowFieldsList( 'field-block-', '<?=$id?>', false, '<?=$field["VALUE"]?>' )" title="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>
            ...
            <div class="const-block hide">
                ...
                "<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_CONDITION_TRUE" )?>"
...
function composite_fieldset_add(){
    ...
    <?if( $nodeType == "truenode" ){?>
        <div class="composite-data-item" data-id="<?=$id?>" style="margin: 10px 0px 0px 0px;">
            ...
            <input class="field-block-composite hide" readonly="readonly" name="PROFILE[XMLDATA][<?=$rowId?>][COMPOSITE_TRUE][<?=$id?>][COMPOSITE_TRUE_VALUE_SHOW]" data-id="<?=$id?>" type="text" value="<?=GetMessage( "ACRIT_EXPORTPROPLUS_NE_VYBRANO" );?>" />
            <span class="field-edit-composite fieldselecter hide" onclick="ShowFieldsList( 'field-block-composite-', '<?=$rowId?>', '<?=$id?>', '' )" title="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>

            <div id="field-block-composite-<?=$rowId?>-<?=$id?>-list" class="fields-popup-list" style="display: none">
                <input onkeyup="FilterFieldsList( this, 'field-block-composite-<?=$rowId?>-<?=$id?>-list' )" placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_MARKET_CATEGORY_DATA_WINDOW_PLACEHOLDER" );?>">
            ...
            <div class="const-block-composite hide">
                <textarea name="PROFILE[XMLDATA][<?=$rowId?>][COMPOSITE_TRUE][<?=$id?>][COMPOSITE_TRUE_CONTVALUE]" data-placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_CONDITION_TRUE" )?>" style="width: 420px;"></textarea>
            </div>
        </div>
    <?}
    elseif( $nodeType == "falsenode" ){?>
        <div class="composite-data-item" data-id="<?=$id?>" style="margin: 10px 0px 0px 0px;">
            ...
            <input class="field-block-composite hide" readonly="readonly" name="PROFILE[XMLDATA][<?=$rowId?>][COMPOSITE_FALSE][<?=$id?>][COMPOSITE_FALSE_VALUE_SHOW]" data-id="<?=$id?>" type="text" value="<?=GetMessage( "ACRIT_EXPORTPROPLUS_NE_VYBRANO" );?>" />
            <span class="field-edit-composite fieldselecter hide" onclick="ShowFieldsList( 'field-block-composite-', '<?=$rowId?>', '<?=$id?>', '' )" title="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>
            ...
            <div class="const-block-composite hide">
                <textarea name="PROFILE[XMLDATA][<?=$rowId?>][COMPOSITE_FALSE][<?=$id?>][COMPOSITE_FALSE_CONTVALUE]" data-placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_CONDITION_FALSE" )?>" style="width: 420px;"></textarea>
            </div>
        </div>
    <?}?>
    <?$data = ob_get_clean();
...
function arithmetics_fieldset_add(){
    ...
    <?if( $nodeType == "truenode" ){?>
        <div class="arithmetics-data-item" data-id="<?=$id?>" style="margin: 10px 0px 0px 0px;">
            <label><?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_ARITHMETICS_OP_HELP" )?>x<?=$id?></label><br/>
            ...
            <input class="field-block-arithmetics hide" readonly="readonly" name="PROFILE[XMLDATA][<?=$rowId?>][ARITHMETICS_TRUE][<?=$id?>][ARITHMETICS_TRUE_VALUE_SHOW]" data-id="<?=$id?>" type="text" value="<?=GetMessage( "ACRIT_EXPORTPROPLUS_NE_VYBRANO" );?>" />
            <span class="field-edit-arithmetics fieldselecter hide" onclick="ShowFieldsList( 'field-block-arithmetics-', '<?=$rowId?>', '<?=$id?>', '' )" title="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>

            <div id="field-block-arithmetics-<?=$rowId?>-<?=$id?>-list" class="fields-popup-list" style="display: none">
                <input onkeyup="FilterFieldsList( this, 'field-block-arithmetics-<?=$rowId?>-<?=$id?>-list' )" placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_MARKET_CATEGORY_DATA_WINDOW_PLACEHOLDER" );?>">
            ...
            <div class="const-block-arithmetics hide">
                <textarea name="PROFILE[XMLDATA][<?=$rowId?>][ARITHMETICS_TRUE][<?=$id?>][ARITHMETICS_TRUE_CONTVALUE]" data-placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_CONDITION_TRUE" )?>" style="width: 420px;"></textarea>
            </div>
        </div>
    <?}
    elseif( $nodeType == "falsenode" ){?>
        <div class="arithmetics-data-item" data-id="<?=$id?>" style="margin: 10px 0px 0px 0px;">
            ...
            <input class="field-block-arithmetics hide" readonly="readonly" name="PROFILE[XMLDATA][<?=$rowId?>][ARITHMETICS_FALSE][<?=$id?>][ARITHMETICS_FALSE_VALUE_SHOW]" data-id="<?=$id?>" type="text" value="<?=GetMessage( "ACRIT_EXPORTPROPLUS_NE_VYBRANO" );?>" />
            <span class="field-edit-arithmetics fieldselecter hide" onclick="ShowFieldsList( 'field-block-arithmetics-', '<?=$rowId?>', '<?=$id?>', '' )" title="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>
            ...
            <div class="const-block-arithmetics hide">
                <textarea name="PROFILE[XMLDATA][<?=$rowId?>][ARITHMETICS_FALSE][<?=$id?>][ARITHMETICS_FALSE_CONTVALUE]" data-placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_CONDITION_FALSE" )?>" style="width: 420px;"></textarea>
            </div>
        </div>
    <?}?>
    <?$data = ob_get_clean();
...
function stack_fieldset_add(){
    ...
    <?if( $nodeType == "truenode" ){?>
        <div class="stack-data-item" data-id="<?=$id?>" style="margin: 10px 0px 0px 0px;">
            ...
            <input class="field-block-stack hide" readonly="readonly" name="PROFILE[XMLDATA][<?=$rowId?>][STACK_TRUE][<?=$id?>][STACK_TRUE_VALUE_SHOW]" data-id="<?=$id?>" type="text" value="<?=GetMessage( "ACRIT_EXPORTPROPLUS_NE_VYBRANO" );?>" />
            <span class="field-edit-stack fieldselecter hide" onclick="ShowFieldsList( 'field-block-stack-', '<?=$rowId?>', '<?=$id?>', '' )" title="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>

            <div id="field-block-stack-<?=$rowId?>-<?=$id?>-list" class="fields-popup-list" style="display: none">
                <input onkeyup="FilterFieldsList( this, 'field-block-stack-<?=$rowId?>-<?=$id?>-list' )" placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_MARKET_CATEGORY_DATA_WINDOW_PLACEHOLDER" );?>">
            ...
            <div class="const-block-stack hide">
                <textarea name="PROFILE[XMLDATA][<?=$rowId?>][STACK_TRUE][<?=$id?>][STACK_TRUE_CONTVALUE]" data-placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_CONDITION_TRUE" )?>" style="width: 420px;"></textarea>
            </div>
        </div>
    <?}
    elseif( $nodeType == "falsenode" ){?>
        <div class="stack-data-item" data-id="<?=$id?>" style="margin: 10px 0px 0px 0px;">
            ...
            <input class="field-block-stack hide" readonly="readonly" name="PROFILE[XMLDATA][<?=$rowId?>][STACK_FALSE][<?=$id?>][STACK_FALSE_VALUE_SHOW]" data-id="<?=$id?>" type="text" value="<?=GetMessage( "ACRIT_EXPORTPROPLUS_NE_VYBRANO" );?>" />
            <span class="field-edit-stack fieldselecter hide" onclick="ShowFieldsList( 'field-block-stack-', '<?=$rowId?>', '<?=$id?>', '' )" title="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>
            ...
            <div class="const-block-stack hide">
                <textarea name="PROFILE[XMLDATA][<?=$rowId?>][STACK_FALSE][<?=$id?>][STACK_FALSE_CONTVALUE]" data-placeholder="<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_CONDITION_FALSE" )?>" style="width: 420px;"></textarea>
            </div>
        </div>
    <?}?>
    <?$data = ob_get_clean();
    ...
    <tr data-id="<?=$id?>">
        ...
        <td align="center">
            <div class="adm-input-wrap adm-input-wrap-calendar">
                ...
                <span class="adm-calendar-icon" title="<?=GetMessage( "ACRIT_EXPORTPROPLUS_NAJMITE_DLA_VYBORA_D" )?>" onclick="BX.calendar( { node: this, field: 'PROFILE[SETUP][CRON][<?=$id;?>][DAT_START]', form: '', bTime: true, bHideTime: false } );"></span>
            </div>
        </td>
        <td align="center">
...
function change_type(){
    ...
    if( !isset( $_REQUEST["ID"] ) ){
        ...
        <?if( strlen( $types[$PROFILE["TYPE"]]["PORTAL_VALIDATOR"] ) > 0 ){?>
            <div style="float: left;">
                <input type="text" size="30" name="PROFILE[SETUP][URL_DATA_FILE]" id="URL_DATA_FILE" value="/acrit.exportproplus/<?=$profileCode?>.<?if( $PROFILE["TYPE"] == "advantshop" ):?>csv<?else:?>xml<?endif;?>"/>
        ...
        <tr class="fieldset-item" data-id="<?=$idCnt++?>">
            ...
            <td colspan="2" style="position: relative" class="adm-detail-content-cell-r">
                ...
                <div style="margin: 10px 0px 10px 15px;">
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_REQUIRED' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_REQUIRED_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_CONDITION' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_CONDITION_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_FORCE' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_FORCE_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_ROWFORCE' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_ROWFORCE_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_URL_ENCODE' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_URL_ENCODE_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_CONVERT_CASE' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_CONVERT_CASE_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_HTML_ENCODE' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_HTML_ENCODE_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_HTML_ENCODE_CUT' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_HTML_ENCODE_CUT_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_HTML_TO_TXT' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_HTML_TO_TXT_HELP" )?>');</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_SKIP_UNTERM_ELEMENT' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_SKIP_UNTERM_ELEMENT_HELP" )?>' );</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_TO_STRING' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_MULTIPROP_TO_STRING_HELP" )?>' );</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_DIVIDER' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_MULTIPROP_DIVIDER_HELP" )?>' );</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_LIMIT' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_MULTIPROP_LIMIT_HELP" )?>' );</script>
                    ...
                    <script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_TEXT_LIMIT' ), '<?=GetMessage( "ACRIT_EXPORTPROPLUS_FIELDSET_TEXT_LIMIT_HELP" )?>' );</script>
    ...
    <td width="60%" class="adm-detail-content-cell-r" align="left">
        <a class="adm-btn adm-btn-red" href="/bitrix/tools/acrit.exportproplus/acrit_exportproplus.php" target="_blank"><?=( ( ( $PROFILE["TYPE"] != "ozon_api" ) && ( $PROFILE["TYPE"] != "vk_trade" ) && ( $PROFILE["TYPE"] != "fb_trade" ) && ( $PROFILE["TYPE"] != "instagram_trade" ) && ( $PROFILE["TYPE"] != "ok_trade" ) ) ? GetMessage( "ACRIT_EXPORTPROPLUS_RUN_FILE_EXPORT" ) : GetMessage( "ACRIT_EXPORTPROPLUS_RUN_FILE_EXPORT_VK" ) )?></a>
        <br/><br/>
        <span class="important-info"><?=( ( ( $PROFILE["TYPE"] != "ozon_api" ) && ( $PROFILE["TYPE"] != "vk_trade" ) && ( $PROFILE["TYPE"] != "fb_trade" ) && ( $PROFILE["TYPE"] != "instagram_trade" ) && ( $PROFILE["TYPE"] != "ok_trade" ) ) ? GetMessage( "ACRIT_EXPORTPROPLUS_FILE_EXPORT_NOT_EXIST" ) : GetMessage( "ACRIT_EXPORTPROPLUS_FILE_EXPORT_NOT_EXIST_VK" ) )?></span>
    </td>
    ...
    <td width="40%" class="adm-detail-content-cell-l"></td>
    <td width="60%" class="adm-detail-content-cell-r" align="left">
        <a class="adm-btn adm-btn-red" onclick="$( 'input[name=apply]' ).click();"><?=( ( ( $PROFILE["TYPE"] != "ozon_api" ) && ( $PROFILE["TYPE"] != "vk_trade" ) && ( $PROFILE["TYPE"] != "fb_trade" ) && ( $PROFILE["TYPE"] != "instagram_trade" ) && ( $PROFILE["TYPE"] != "ok_trade" ) ) ? GetMessage( "ACRIT_EXPORTPROPLUS_RUN_FILE_EXPORT" ) : GetMessage( "ACRIT_EXPORTPROPLUS_RUN_FILE_EXPORT_VK" ) )?></a>
        <br/><br/>
        <span class="important-info"><?=( ( ( $PROFILE["TYPE"] != "ozon_api" ) && ( $PROFILE["TYPE"] != "vk_trade" ) && ( $PROFILE["TYPE"] != "fb_trade" ) && ( $PROFILE["TYPE"] != "instagram_trade" ) && ( $PROFILE["TYPE"] != "ok_trade" ) ) ? GetMessage( "ACRIT_EXPORTPROPLUS_FILE_EXPORT_NOT_EXIST" ) : GetMessage( "ACRIT_EXPORTPROPLUS_FILE_EXPORT_NOT_EXIST_VK" ) )?></span>
    </td>
    ...
    ob_start();?>
    <div class="adm-info-message"><?=( ( ( $PROFILE["TYPE"] != "ozon_api" ) && ( $PROFILE["TYPE"] != "vk_trade" ) && ( $PROFILE["TYPE"] != "fb_trade" ) && ( $PROFILE["TYPE"] != "instagram_trade" ) && ( $PROFILE["TYPE"] != "ok_trade" ) ) ? GetMessage( "ACRIT_EXPORTPROPLUS_RUNTYPE_INFO" ) : GetMessage( "ACRIT_EXPORTPROPLUS_RUNTYPE_INFO_VK" ) )?></div>
...
function is_url_used(){
  ...
  $intProfileID = IntVal($_REQUEST['id']);
	$SQL = 'SELECT `ID`,`SETUP` FROM `acrit_exportproplus_profile` WHERE `ID`<>'.$intProfileID.';';
