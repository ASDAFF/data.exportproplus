...
$MESS['ACRIT_CORE_TAB_AGENTS_NAME'] = 'Агенты';
	$MESS['ACRIT_CORE_TAB_AGENTS_DESC'] = 'Агенты';
$MESS['ACRIT_CORE_TAB_SUPPORT_NAME'] = 'Опции и Техподдержка';
	$MESS['ACRIT_CORE_TAB_SUPPORT_DESC'] = 'Опции и Техподдержка';
$MESS['ACRIT_CORE_TAB_CRM_NAME'] = 'Интеграция с CRM';
	$MESS['ACRIT_CORE_TAB_CRM_DESC'] = 'Интеграция с CRM';

// Old core: Agents
$MESS["SC_SET_CRON_AGENTS_OPTIONS"] = "Отключить выполнение агентов на хитах";
$MESS["ACRIT_EXPORTPROPLUS_SET_CRON_AGENTS_OPTIONS_BUTTON"] = "Отключить агенты на хитах";
$MESS["SC_SET_CRON_AGENTS_INFO"] = "Пошаговая инструкция запуска агентов на Cron";
$MESS["ACRIT_EXPORTPROPLUS_SET_CRON_AGENTS_OPTIONS_STEPS"] = "
<ol type=\"1\">
...
$MESS["ACRIT_EXPORTPROPLUS_SET_BITRIX_CLOUD_MONITORING_BUTTON_OFF"] = "Отключить мониторинг работы модуля";
$MESS["ACRIT_EXPORTPROPLUS_SET_BITRIX_CLOUD_MONITORING_BUTTON_ON"] = "Включить мониторинг работы модуля";
