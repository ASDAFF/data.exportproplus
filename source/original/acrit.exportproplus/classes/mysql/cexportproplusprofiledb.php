...
class CExportproplusProfileDB{
    ...
    private $profileTableName = "acrit_exportproplus_profile";
    private $dataTableName = "acrit_exportproplus_profile_data";
    private $toolsTableName = "acrit_exportproplus_profile_tools";
			...
			foreach( $aFilter as $key => $val ){
				...
				switch( strtoupper( $key ) ){
				    ...
				    case "USE_REMARKETING":
                        ...
                        break;
                    case "USE_GOOGLETAGMANAGER":
				        $arFilter[] = "P.USE_GOOGLETAGMANAGER='".$val."'";
				        break;
				}
			}
		}
