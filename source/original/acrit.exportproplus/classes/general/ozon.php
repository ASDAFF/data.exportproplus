                                ...
                                if( is_array( $arProductData ) && !empty( $arProductData ) && ( intval( $arProductData["Products"][0]["ProductId"] ) > 0 ) ){
                                    ...
                                    if( $arOzonJobInfo["JobInfo"]["State"] == "Finished" ){
                                        if( $arOzonJobInfo["ProcessingInfos"]["0"]["Activity"] != "Error" ){
                                            ...
                                            $obLog->AddMessage( "(ID: {$arOzonJobInfo["JobInfo"]["EntityId"]}) : ".str_replace( "#OZON_ERROR#", $arErrorData["Entities"]["#"]["Entity"][0]["#"]["ErrorCode"][0]["#"].": ".$arErrorData["Entities"]["#"]["Entity"][0]["#"]["ErrorData"][0]["#"], GetMessage( "ACRIT_EXPORTPROPLUS_REQUIRED_FIELD_OZON_SKIP" ) ) );
