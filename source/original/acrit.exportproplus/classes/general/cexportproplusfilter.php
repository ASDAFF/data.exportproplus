...
class CAcritExportproplusCatalog extends CAcritCatalogCondCtrlIBlockFields{
        ...
        $arControlList = array(
            "CondExportproplusSetContains" => array(
                ...
                "JS_VALUE" => array(
                    ...
                    "popup_params" => array(
                        "lang" => LANGUAGE_ID,
                        "IBLOCK_ID" => CAcritExportproplusProps::$arIBlockFilter[0],
                        "discount" => "Y"
                    ),
                    "param_id" => "n"
                ),
...
class CAcritExportproplusPrices extends CAcritCatalogCondCtrlIBlockFields{
    public static function GetClassName(){
        return __CLASS__;
    }
...
class CAcritExportproplusProps extends CAcritCatalogCondCtrlIBlockProps{
...
class CAcritExportproplusCatalogCond extends CAcritGlobalCondTree{
    public static function GetClassName(){
        return __CLASS__;
    }
    ...
    public function OnConditionControlBuildList(){
        if( !$this->boolError && !isset( $this->arControlList ) ){
            ...
            $basicEvents = array_merge( $basicEvents, array(
                    array(
                        "TO_CLASS" => "CAcritExportproplusPrices",
                        "TO_METHOD" => "GetControlDescr"
                    ),
                    array(
                        "TO_CLASS" => "CAcritExportproplusCatalog",
                        "TO_METHOD" => "GetControlDescr"
                    ),
                )
            );
            foreach( $basicEvents as $arEvent ){
                if( $arEvent["TO_CLASS"] == "CAcritCatalogCondCtrlIBlockProps" ){
                    $arEvent["TO_CLASS"] = "CAcritExportproplusProps";
                    $arEvent["TO_MODULE_ID"] = "acrit.exportproplus";
                    $arEvent["TO_NAME"] = "CAcritExportproplusProps::GetControlDescr (acrit.exportproplus)";
                }
