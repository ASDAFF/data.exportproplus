CREATE TABLE IF NOT EXISTS `acrit_exportproplus_profile`(
    ...
    `USE_GOOGLETAGMANAGER` CHAR(1) DEFAULT 'N' NOT NULL,
    ...
    `GOOGLETAGMANAGER_ID` VARCHAR(100) NULL,
...
CREATE TABLE IF NOT EXISTS `acrit_exportproplus_profile_data`(
    `ID` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `acrit_exportproplus_profile_tools`(
    `ID` int(11) NOT NULL auto_increment,
    `PROFILE_ID` int(11) NOT NULL,
