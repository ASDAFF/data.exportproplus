...
<?}
            ...
            <div class="adm-detail-content">
                <div class="adm-detail-content-item-block" style="height: auto; overflow-y: visible;">
                    <table class="adm-detail-content-table edit-table">
                        <tr class="heading"><td><?=GetMessage( "ACRIT_EXPORTPROPLUS_PROFILE_TABLE_EXPORT_IMPORT_TITLE" )?></td></tr>
                        <tr align="center">
                            <td>
                                <form method="post">
                                    ...
                                    <input type="submit" class="adm-btn-save" value="<?=GetMessage( "ACRIT_EXPORTPROPLUS_PROFILE_LIST_PROCESS" )?>">
                                </form>
                                <br/><br/>
                            </td>
                        </tr>
    ...
    if( $_REQUEST["export_import"] == "export" ){
        ...
        if( $_REQUEST["step"] != 2 ){
            ...
            <div class="adm-detail-content-wrap">
                <div class="adm-detail-content">
                    <div class="adm-detail-content-item-block" style="height: auto; overflow-y: visible;">
                        <table class="adm-detail-content-table edit-table">
                            <tr class="heading"><td><?=GetMessage( "ACRIT_EXPORTPROPLUS_PROFILE_TABLE_EXPORT_TITLE" )?></td></tr>
                            <tr align="center">
                                <td>
                                    <form name="exportproplusfile_form">
                                        ...
                                        <br/><br/>
                                        <a href="/bitrix/admin/acrit_exportproplus_export.php" class="adm-btn"><?=GetMessage( "ACRIT_EXPORTPROPLUS_PROFILE_LIST_BACK" )?></a>&nbsp;&nbsp;&nbsp;
                                        <input type="submit" class="adm-btn-save" value="<?=GetMessage( "ACRIT_EXPORTPROPLUS_PROFILE_LIST_PROCESS" )?>">
                                    </form>
                                    <br/><br/>
                                </td>
        ...
        //  show table & export
            ...
            ?>
            <br/>
            <a href="/bitrix/admin/acrit_exportproplus_list.php" class="adm-btn"><?=GetMessage( "ACRIT_EXPORTPROPLUS_PROFILE_LIST" )?></a>&nbsp;&nbsp;&nbsp;
        ...
        if( $_REQUEST["step"] != 2 ){?>
            <div class="adm-detail-content-wrap">
                <div class="adm-detail-content">
                    <div class="adm-detail-content-item-block" style="height: auto; overflow-y: visible;">
                        <table class="adm-detail-content-table edit-table">
                            <tr class="heading"><td><?=GetMessage( "ACRIT_EXPORTPROPLUS_PROFILE_TABLE_IMPORT_TITLE" )?></td></tr>
                            <tr align="center">
                                <td>
