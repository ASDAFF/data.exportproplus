...
class FacebookUrlDetectionHandler implements UrlDetectionInterface
{
    ...
    {
        $redirectUrl = ( ( \Bitrix\Main\Context::getCurrent()->getRequest()->isHttps() ) ? "https" : "http" ) . '://' . $this->getHostName() . $this->getServerVar('REQUEST_URI');
        $redirectUrl = str_replace( array( ":80", ":8080", ":443" ), "", $redirectUrl );
        return $redirectUrl;
    }
