...
// Main notice
$MESS['DATA_EXP_MAIN_NOTICE_FOR_HINTS'] = '<b>Внимательно читайте подсказки к настройкам!</b> Подсказки (<span id="hint_main_noice"></span><script>BX.hint_replace(BX("hint_main_noice"), "Это подсказка!");</script> ) содержат много полезной информации, без знания которой легко совершить ошибки в настройке. <a href="#" data-role="main-notice-hide">Больше не показывать</a>';
