<?
$MESS['DATA_CORE_TAB_GENERAL_NAME'] = 'Общие настройки';
	$MESS['DATA_CORE_TAB_GENERAL_DESC'] = 'Общие настройки';
$MESS['DATA_CORE_TAB_LOG_NAME'] = 'Лог';
	$MESS['DATA_CORE_TAB_LOG_DESC'] = 'Общий лог модуля';
$MESS['DATA_CORE_TAB_AGENTS_NAME'] = 'Агенты';
	$MESS['DATA_CORE_TAB_AGENTS_DESC'] = 'Агенты';
$MESS['DATA_CORE_TAB_SUPPORT_NAME'] = 'Опции и Техподдержка';
	$MESS['DATA_CORE_TAB_SUPPORT_DESC'] = 'Опции и Техподдержка';
$MESS['DATA_CORE_TAB_CRM_NAME'] = 'Интеграция с CRM';
	$MESS['DATA_CORE_TAB_CRM_DESC'] = 'Интеграция с CRM';

// Old core: Agents
$MESS["SC_SET_CRON_AGENTS_OPTIONS"] = "Отключить выполнение агентов на хитах";
$MESS["DATA_EXPORTPROPLUS_SET_CRON_AGENTS_OPTIONS_BUTTON"] = "Отключить агенты на хитах";
$MESS["SC_SET_CRON_AGENTS_INFO"] = "Пошаговая инструкция запуска агентов на Cron";
$MESS["DATA_EXPORTPROPLUS_SET_CRON_AGENTS_OPTIONS_STEPS"] = "
<ol type=\"1\">
...
$MESS["DATA_EXPORTPROPLUS_MARKET_CATEGORIES_UPDATE_BUTTON"] = "Обновить категории выгрузки относительно Торговых порталов";
$MESS["SC_SET_BITRIX_CLOUD_MONITORING_OPTIONS"] = "Мониторинг работы модуля";
$MESS["SC_SET_BITRIX_CLOUD_MONITORING_EMAIL"] = "admin@data.ru";
$MESS["DATA_EXPORTPROPLUS_SET_BITRIX_CLOUD_MONITORING_BUTTON_OFF"] = "Отключить мониторинг работы модуля";
$MESS["DATA_EXPORTPROPLUS_SET_BITRIX_CLOUD_MONITORING_BUTTON_ON"] = "Включить мониторинг работы модуля";
...
$MESS["DATA_EXPORTPROPLUS_RECOMMENDS"] = "
