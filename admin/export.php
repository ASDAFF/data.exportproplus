...
$APPLICATION->SetTitle(GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_BACKUP_TITLE"));
        ...
        <div class="adm-detail-content">
            <div class="adm-detail-content-item-block" style="height: auto; overflow-y: visible;">
                <table class="adm-detail-content-table edit-table">
                    <tr class="heading">
                        <td><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_TABLE_EXPORT_IMPORT_TITLE") ?></td>
                    </tr>
                    <tr align="center">
                        <td>
                            <form method="post">
                                <div style="margin: 20px">
                                    ...
                                    <label for="action"><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_EXPORT_TITLE") ?></label>

                                    <input type="radio" name="export_import" value="import">
                                    <label for="action"><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_IMPORT_TITLE") ?></label>

                                    <input type="radio" name="export_import" value="merge">
                                    <label for="action"><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_MERGE_TITLE") ?></label>
                                </div>
                                <input type="submit" class="adm-btn-save"
                                       value="<?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_PROCESS") ?>">
                            </form>
                            <br/><br/>
                        </td>
                    </tr>
...
if ($_REQUEST["export_import"] == "export") {
    $APPLICATION->SetTitle(GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_EXPORT_TITLE"));
    ...
    if ($_REQUEST["step"] != 2) {
        ...
        <div class="adm-detail-content-wrap">
            <div class="adm-detail-content">
                <div class="adm-detail-content-item-block" style="height: auto; overflow-y: visible;">
                    <table class="adm-detail-content-table edit-table">
                        <tr class="heading">
                            <td><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_TABLE_EXPORT_TITLE") ?></td>
                        </tr>
                        <tr align="center">
                            <td>
                                <form name="exportproplusfile_form">
                                    <br/>
                                    <label style="font-size: 14px"><b><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_EXPORT_FILE_TITLE") ?></b></label>
                                    &nbsp;&nbsp;&nbsp;
                                    ...
                                    <br/><br/>
                                    <a href="/bitrix/admin/data_exportproplus_export.php"
                                       class="adm-btn"><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_BACK") ?></a>&nbsp;&nbsp;&nbsp;
                                    <input type="submit" class="adm-btn-save"
                                           value="<?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_PROCESS") ?>">
                                </form>
                                <br/><br/>
        ...
        if (($arID = $obAdminList->GroupAction()) && $POST_RIGHT == "W") {
            ...
            if ($_REQUEST["URL_DATA_FILE_EXPORT"]) {
                ...
                $message = GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_EXPORTED1") . "<ul>" . implode("\r\n", $message) . "</ul>"
                    . str_replace("#FILE#", "http://" . CDataExportproplusTools::GetHttpHost() . $_REQUEST["URL_DATA_FILE_EXPORT"], GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_EXPORTED2"));
            ...
            if ($_REQUEST["URL_DATA_FILE_EXPORT"]) {
                ...
                $directMessage = GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_EXPORTED1") . "<ul>" . implode("\r\n", $message) . "</ul>"
                    . str_replace("#FILE#", "http://" . CDataExportproplusTools::GetHttpHost() . $_REQUEST["URL_DATA_FILE_EXPORT"], GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_EXPORTED2"));
        ...
        while ($arAdminResultRow = $obAdminResult->NavNext(true, "f_")) {
            ...
            $row->AddViewField("TYPE_RUN", $f_TYPE_RUN == "comp" ? GetMessage("DATA_EXPORTPROPLUS_RUN_TYPE_COMPONENT") : GetMessage("DATA_EXPORTPROPLUS_RUN_TYPE_CRON"));
        ...
        $obAdminList->AddGroupActionTable(
            array(
                "export" => GetMessage("DATA_EXPORTPROPLUS_PROFILE_EXPORT_SHORT"),
            )
        );
        ...
        $APPLICATION->SetTitle(GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_EXPORT_POST_TITLE"));
        ...
        ?>
        <br/>
        <a href="/bitrix/admin/data_exportproplus_list.php"
           class="adm-btn"><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST") ?></a>&nbsp;&nbsp;&nbsp;

        <?
    }
} elseif ($_REQUEST["export_import"] == "import") {
    $APPLICATION->SetTitle(GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_IMPORT_TITLE"));
    ...
    if ($_REQUEST["step"] != 2) {
        ...
        <div class="adm-detail-content-wrap">
            <div class="adm-detail-content">
                <div class="adm-detail-content-item-block" style="height: auto; overflow-y: visible;">
                    <table class="adm-detail-content-table edit-table">
                        <tr class="heading">
                            <td><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_TABLE_IMPORT_TITLE") ?></td>
                        </tr>
                        <tr align="center">
                            <td>
                                <form name="exportproplusfile_form" method="post">
                                    <br/>
                                    <label style="font-size: 14px"><b><?= GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_IMPORT_FILE_TITLE") ?></b></label>
                                    &nbsp;&nbsp;&nbsp;
        ...
        if (count($arMessageList) > 0) {
            $arMessageList = GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_EXPORTED3") . "<ul>" . implode("\r\n", $arMessageList) . "</ul>";
    ...
    $APPLICATION->SetTitle(GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_MERGE_TITLE"));
    ...
    $obAdminList->AddAdminContextMenu($aContext);
    $obAdminList->CheckListMode();
    $APPLICATION->SetTitle(GetMessage("DATA_EXPORTPROPLUS_PROFILE_LIST_MERGE_POST_TITLE"));
