...
if( CModule::IncludeModule( "currency" ) ){
	...
	$arCurrencyList = array(
        "RUB" => GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_RUB" ),
		"USD" => GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_USD" ),
		"EUR" => GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_EUR" ),
		"UAH" => GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_UAH" ),
		"BYR" => GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_BYR" ),
		"KZT" => GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_KZH" )
    );
}
...
<tr class="heading">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPROPLUS_CONDITIONS" )?></td>
</tr>
<tr>
    <td width="50%">
        <span id="hint_PROFILE[SETUP][VALIDATE_CONDITIONS]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[SETUP][VALIDATE_CONDITIONS]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_SETUP_VALIDATE_CONDITIONS_HELP" )?>' );</script>
        <label for="PROFILE[SETUP][VALIDATE_CONDITIONS]"><?=GetMessage( "DATA_EXPORTPROPLUS_SETUP_VALIDATE_CONDITIONS" )?></label>
    </td>
    ...
    <td colspan="2">
        <div id="PROFILE_CONDITION">
            <?
                ...
                CDataExportproplusProps::$arIBlockFilter = $obProfileUtils->PrepareIBlock(
                    $arProfile["IBLOCK_ID"],
                    $arProfile["USE_SKU"]
                );
...
<tr class="heading">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPROPLUS_CURRENCU" )?></td>
</tr>
<tr>
    <td width="50%">
        <span id="hint_PROFILE[CURRENCY][CONVERT_CURRENCY]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[CURRENCY][CONVERT_CURRENCY]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_CURRENCY_CONVERT_CURRENCY_HELP" )?>' );</script>
        <label for="PROFILE[CURRENCY][CONVERT_CURRENCY]"><?=GetMessage( "DATA_EXPORTPROPLUS_CURRENCY_CONVERT_CURRENCY" )?></label>
    </td>
...
<tr align="center">
    <td colspan="2">
        <?=BeginNote();?>
        <?=GetMessage( "DATA_EXPORTPROPLUS_MARKET_CURRENCY_DESCRIPTION" )?>
        <?=EndNote();?>
    </td>
</tr>
<tr>
    <td colspan="2" align="center">
        <table cellpadding="2" cellspacing="0" border="0" class="internal" align="center" width="100%">
            <thead>
                <tr class="heading">
                    <td colspan="3" align="left"><?=GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_HEAD_CURRENCY" )?></td>
                    <td align="center" class="currency_table" style="<?=$convertTable?>"><?=GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_HEAD_RATE" )?></td>
                    <td align="center" class="currency_table" style="<?=$convertTable?>"><?=GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_HEAD_CONVERTTO" )?></td>
                    <td align="center"><?=GetMessage( "DATA_EXPORTPROPLUS_CURRENCU_HEAD_CORRECT" )?></td>
                </tr>
            </thead>
            <tbody>
...
<tr class="heading" align="center">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPROPLUS_CONVERT_FIELDSET_HEADER" )?></td>
</tr>
<tr align="center">
    <td colspan="2">
        <?=BeginNote();?>
        <?=GetMessage( "DATA_EXPORTPROPLUS_CONVERT_FIELDSET_DESCRIPTION" )?>
        <?=EndNote();?>
    </td>
</tr>
<tr>
    <td width="50%">
        <span id="hint_PROFILE[SETUP][CONVERT_DATA_REGEXP]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[SETUP][CONVERT_DATA_REGEXP]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_SETUP_CONVERT_DATA_REGEXP_HELP" )?>' );</script>
        <label for="PROFILE[SETUP][CONVERT_DATA_REGEXP]"><?=GetMessage( "DATA_EXPORTPROPLUS_SETUP_CONVERT_DATA_REGEXP" )?></label>
    </td>
...
<tr>
    <td colspan="2" align="center" id="convert-fieldset-item-add-button">
        <button class="adm-btn" onclick="ConvertFieldsetAdd( this ); return false;">
            <?=GetMessage( "DATA_EXPORTPROPLUS_CONVERT_FIELDSET_CONDITION_ADD" )?>
        </button>
    </td>
</tr>

<tr class="heading" align="center">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ADDITIONAL_SETTINGS_HEADER" )?></td>
</tr>
<tr>
    <td width="50%" class="adm-detail-content-cell-l">
				<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ADDITIONAL_SETTINGS_SKU_USE_CANONICAL" )?>
		</td>
...
<tr>
    <td width="50%" class="adm-detail-content-cell-l">
				...
				<script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[OFFER_WITH_SKU_USE_QUANTITY]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ADDITIONAL_SETTINGS_OFFER_WITH_SKU_USE_QUANTITY_HINT" )?>' );</script>
				<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ADDITIONAL_SETTINGS_OFFER_WITH_SKU_USE_QUANTITY" )?>
		</td>
    <td width="50%" class="adm-detail-content-cell-r">
