...
$arRoundModes = array(
    "none" => GetMessage( "DATA_EXPORTPROPLUS_NE_VYBRANO" ),
    "UP" => GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ROUND_MODE_UP" ),
    "DOWN" => GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ROUND_MODE_DOWN" ),
    "EVEN" => GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ROUND_MODE_EVEN" ),
    "ODD" => GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ROUND_MODE_ODD" )
);
$idCnt = 0;
?>
<tr class="heading" align="center">
    <td colspan="2"><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_HEADER" )?></td>
</tr>
<tr align="center">
    <td colspan="2">
        <?=BeginNote();?>
        <?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_DESCRIPTION" )?>
        <?=EndNote();?>
    </td>
</tr>
<tr>
                ...
                <tr class="fieldset-item" data-id="<?=$idCnt++?>">
                    ...
                    <td colspan="2" style="position: relative" class="adm-detail-content-cell-r">
                        ...
                        <div class="const-block <?=$hideConstBlock?>">
                            ...
                            <textarea name="PROFILE[XMLDATA][<?=$id?>][CONTVALUE_TRUE]" <?=$showPlaceholder?>="<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONDITION_TRUE" )?>"><?=$field["CONTVALUE_TRUE"]?></textarea>
                            ...
                            <div class="complex-block">
                                ...
                                <div>
                                    ...
                                    <div class="const-block-complex <?=$hideComplexConstTrueBlock?>">
                                        <textarea name="PROFILE[XMLDATA][<?=$id?>][COMPLEX_TRUE_CONTVALUE]" <?=$showPlaceholder?>="<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONDITION_TRUE" )?>"><?=$field["COMPLEX_TRUE_CONTVALUE"]?></textarea>
                                    </div>
                                </div>
                                <div class="<?=$hideComplexFalse?>">
                                    ...
                                    <div class="const-block-complex-false <?=$hideComplexConstFalseBlock?>">
                                        <textarea name="PROFILE[XMLDATA][<?=$id?>][COMPLEX_FALSE_CONTVALUE]" <?=$showPlaceholder?>="<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONDITION_TRUE" )?>"><?=$field["COMPLEX_FALSE_CONTVALUE"]?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <?if( is_array( $arProfile["XMLDATA"][$id]["COMPOSITE_TRUE"] ) && !empty( $arProfile["XMLDATA"][$id]["COMPOSITE_TRUE"] ) ){
                                            foreach( $arProfile["XMLDATA"][$id]["COMPOSITE_TRUE"] as $compositeTrueId => $arCompositeTrue ){?>
                                                <div class="composite-data-item" data-id="<?=$compositeTrueId?>" style="margin: 10px 0px 0px 0px;">
                                                    ...
                                                    <input class="field-block-composite <?=$hideCompositeFieldTrueBlock?>" readonly="readonly" name="PROFILE[XMLDATA][<?=$id?>][COMPOSITE_TRUE][<?=$compositeTrueId?>][COMPOSITE_TRUE_VALUE_SHOW]" data-id="<?=$id?>" type="text" title="<?=$arLinearFieldsList[$arCompositeTrue["COMPOSITE_TRUE_VALUE"]];?>" value="<?=( isset( $arLinearFieldsList[$arCompositeTrue["COMPOSITE_TRUE_VALUE"]] ) ? $arLinearFieldsList[$arCompositeTrue["COMPOSITE_TRUE_VALUE"]] : GetMessage( "DATA_EXPORTPROPLUS_NE_VYBRANO" ) );?>" />
                                                    <span class="field-edit-composite fieldselecter <?=$hideCompositeFieldTrueBlock?>" onclick="ShowFieldsList( 'field-block-composite-', '<?=$id?>', '<?=$compositeTrueId?>', '<?=$arCompositeTrue["COMPOSITE_TRUE_VALUE"]?>' )" title="<?=GetMessage( "DATA_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>

                                                    <div id="field-block-composite-<?=$id?>-<?=$compositeTrueId?>-list" class="fields-popup-list" style="display: none;">
                                                        <input onkeyup="FilterFieldsList( this, 'field-block-composite-<?=$id?>-<?=$compositeTrueId?>-list' )" placeholder="<?=GetMessage( "DATA_EXPORTPROPLUS_MARKET_CATEGORY_DATA_WINDOW_PLACEHOLDER" );?>" value="<?=( isset( $arLinearFieldsList[$arCompositeTrue["COMPOSITE_TRUE_VALUE"]] ) ? $arLinearFieldsList[$arCompositeTrue["COMPOSITE_TRUE_VALUE"]] : "" )?>">
                                        ...
                                        <?if( is_array( $arProfile["XMLDATA"][$id]["COMPOSITE_FALSE"] ) && !empty( $arProfile["XMLDATA"][$id]["COMPOSITE_FALSE"] ) ){
                                            foreach( $arProfile["XMLDATA"][$id]["COMPOSITE_FALSE"] as $compositeFalseId => $arCompositeFalse ){?>
                                                <div class="composite-data-item" data-id="<?=$compositeFalseId?>" style="margin: 10px 0px 0px 0px;">
                                                    ...
                                                    <input class="field-block-composite <?=$hideCompositeFieldFalseBlock?>" readonly="readonly" name="PROFILE[XMLDATA][<?=$id?>][COMPOSITE_FALSE][<?=$compositeFalseId?>][COMPOSITE_FALSE_VALUE_SHOW]" data-id="<?=$id?>" type="text" title="<?=$arLinearFieldsList[$arCompositeFalse["COMPOSITE_FALSE_VALUE"]];?>" value="<?=( isset( $arLinearFieldsList[$arCompositeFalse["COMPOSITE_FALSE_VALUE"]] ) ? $arLinearFieldsList[$arCompositeFalse["COMPOSITE_FALSE_VALUE"]] : GetMessage( "DATA_EXPORTPROPLUS_NE_VYBRANO" ) );?>" />
                                                    <span class="field-edit-composite fieldselecter <?=$hideCompositeFieldFalseBlock?>" onclick="ShowFieldsList( 'field-block-composite-', '<?=$id?>', '<?=$compositeFalseId?>', '<?=$arCompositeTrue["COMPOSITE_FALSE_VALUE"]?>' )" title="<?=GetMessage( "DATA_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>

                                                    <div id="field-block-composite-<?=$id?>-<?=$compositeFalseId?>-list" class="fields-popup-list" style="display: none;">
                                                        <input onkeyup="FilterFieldsList( this, 'field-block-composite-<?=$id?>-<?=$compositeFalseId?>-list' )" placeholder="<?=GetMessage( "DATA_EXPORTPROPLUS_MARKET_CATEGORY_DATA_WINDOW_PLACEHOLDER" );?>" value="<?=( isset( $arLinearFieldsList[$arCompositeFalse["COMPOSITE_FALSE_VALUE"]] ) ? $arLinearFieldsList[$arCompositeFalse["COMPOSITE_FALSE_VALUE"]] : "" )?>">
                                        ...
                                        <?if( is_array( $arProfile["XMLDATA"][$id]["ARITHMETICS_TRUE"] ) && !empty( $arProfile["XMLDATA"][$id]["ARITHMETICS_TRUE"] ) ){
                                            foreach( $arProfile["XMLDATA"][$id]["ARITHMETICS_TRUE"] as $arithmeticsTrueId => $arArithmeticsTrue ){?>
                                                <div class="arithmetics-data-item" data-id="<?=$arithmeticsTrueId?>" style="margin: 10px 0px 0px 0px;">
                                                    <label><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ARITHMETICS_OP_HELP" )?>x<?=$arithmeticsTrueId?></label><br/>
                                                    ...
                                                    <input class="field-block-arithmetics <?=$hideArithmeticsFieldTrueBlock?>" readonly="readonly" name="PROFILE[XMLDATA][<?=$id?>][ARITHMETICS_TRUE][<?=$arithmeticsTrueId?>][ARITHMETICS_TRUE_VALUE_SHOW]" data-id="<?=$id?>" type="text" title="<?=$arLinearFieldsList[$arArithmeticsTrue["ARITHMETICS_TRUE_VALUE"]];?>" value="<?=( isset( $arLinearFieldsList[$arArithmeticsTrue["ARITHMETICS_TRUE_VALUE"]] ) ? $arLinearFieldsList[$arArithmeticsTrue["ARITHMETICS_TRUE_VALUE"]] : GetMessage( "DATA_EXPORTPROPLUS_NE_VYBRANO" ) );?>" />
                                                    <span class="field-edit-arithmetics fieldselecter <?=$hideArithmeticsFieldTrueBlock?>" onclick="ShowFieldsList( 'field-block-arithmetics-', '<?=$id?>', '<?=$arithmeticsTrueId?>', '<?=$arArithmeticsTrue["ARITHMETICS_TRUE_VALUE"]?>' )" title="<?=GetMessage( "DATA_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>

                                                    <div id="field-block-arithmetics-<?=$id?>-<?=$arithmeticsTrueId?>-list" class="fields-popup-list" style="display: none;">
                                                        <input onkeyup="FilterFieldsList( this, 'field-block-arithmetics-<?=$id?>-<?=$arithmeticsTrueId?>-list' )" placeholder="<?=GetMessage( "DATA_EXPORTPROPLUS_MARKET_CATEGORY_DATA_WINDOW_PLACEHOLDER" );?>" value="<?=( isset( $arLinearFieldsList[$arArithmeticsTrue["ARITHMETICS_TRUE_VALUE"]] ) ? $arLinearFieldsList[$arArithmeticsTrue["ARITHMETICS_TRUE_VALUE"]] : "" )?>">
                                        ...
                                        <?if( is_array( $arProfile["XMLDATA"][$id]["ARITHMETICS_FALSE"] ) && !empty( $arProfile["XMLDATA"][$id]["ARITHMETICS_FALSE"] ) ){
                                            foreach( $arProfile["XMLDATA"][$id]["ARITHMETICS_FALSE"] as $arithmeticsFalseId => $arArithmeticsFalse ){?>
                                                <div class="arithmetics-data-item" data-id="<?=$arithmeticsFalseId?>" style="margin: 10px 0px 0px 0px;">
                                                    <label><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ARITHMETICS_OP_HELP" )?>x<?=$arithmeticsFalseId?></label><br/>
                                                    ...
                                                    <input class="field-block-arithmetics <?=$hideArithmeticsFieldFalseBlock?>" readonly="readonly" name="PROFILE[XMLDATA][<?=$id?>][ARITHMETICS_FALSE][<?=$arithmeticsFalseId?>][ARITHMETICS_FALSE_VALUE_SHOW]" data-id="<?=$id?>" type="text" title="<?=$arLinearFieldsList[$arArithmeticsFalse["ARITHMETICS_FALSE_VALUE"]];?>" value="<?=( isset( $arLinearFieldsList[$arArithmeticsFalse["ARITHMETICS_FALSE_VALUE"]] ) ? $arLinearFieldsList[$arArithmeticsFalse["ARITHMETICS_FALSE_VALUE"]] : GetMessage( "DATA_EXPORTPROPLUS_NE_VYBRANO" ) );?>" />
                                                    <span class="field-edit-arithmetics fieldselecter <?=$hideArithmeticsFieldFalseBlock?>" onclick="ShowFieldsList( 'field-block-arithmetics-', '<?=$id?>', '<?=$arithmeticsFalseId?>', '<?=$arArithmeticsTrue["ARITHMETICS_FALSE_VALUE"]?>' )" title="<?=GetMessage( "DATA_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>

                                                    <div id="field-block-arithmetics-<?=$id?>-<?=$arithmeticsFalseId?>-list" class="fields-popup-list" style="display: none;">
                                                        <input onkeyup="FilterFieldsList( this, 'field-block-arithmetics-<?=$id?>-<?=$arithmeticsFalseId?>-list' )" placeholder="<?=GetMessage( "DATA_EXPORTPROPLUS_MARKET_CATEGORY_DATA_WINDOW_PLACEHOLDER" );?>" value="<?=( isset( $arLinearFieldsList[$arArithmeticsFalse["ARITHMETICS_FALSE_VALUE"]] ) ? $arLinearFieldsList[$arArithmeticsFalse["ARITHMETICS_FALSE_VALUE"]] : "" )?>">
                                        ...
                                        <?if( is_array( $arProfile["XMLDATA"][$id]["STACK_TRUE"] ) && !empty( $arProfile["XMLDATA"][$id]["STACK_TRUE"] ) ){
                                            foreach( $arProfile["XMLDATA"][$id]["STACK_TRUE"] as $stackTrueId => $arStackTrue ){?>
                                                <div class="stack-data-item" data-id="<?=$stackTrueId?>" style="margin: 10px 0px 0px 0px;">
                                                    ...
                                                    <input class="field-block-stack <?=$hideStackFieldTrueBlock?>" readonly="readonly" name="PROFILE[XMLDATA][<?=$id?>][STACK_TRUE][<?=$stackTrueId?>][STACK_TRUE_VALUE_SHOW]" data-id="<?=$id?>" type="text" title="<?=$arLinearFieldsList[$arStackTrue["STACK_TRUE_VALUE"]];?>" value="<?=( isset( $arLinearFieldsList[$arStackTrue["STACK_TRUE_VALUE"]] ) ? $arLinearFieldsList[$arStackTrue["STACK_TRUE_VALUE"]] : GetMessage( "DATA_EXPORTPROPLUS_NE_VYBRANO" ) );?>" />
                                                    <span class="field-edit-stack fieldselecter <?=$hideStackFieldTrueBlock?>" onclick="ShowFieldsList( 'field-block-stack-', '<?=$id?>', '<?=$stackTrueId?>', '<?=$arStackTrue["STACK_TRUE_VALUE"]?>' )" title="<?=GetMessage( "DATA_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>

                                                    <div id="field-block-stack-<?=$id?>-<?=$stackTrueId?>-list" class="fields-popup-list" style="display: none;">
                                                        <input onkeyup="FilterFieldsList( this, 'field-block-stack-<?=$id?>-<?=$stackTrueId?>-list' )" placeholder="<?=GetMessage( "DATA_EXPORTPROPLUS_MARKET_CATEGORY_DATA_WINDOW_PLACEHOLDER" );?>" value="<?=( isset( $arLinearFieldsList[$arStackTrue["STACK_TRUE_VALUE"]] ) ? $arLinearFieldsList[$arStackTrue["STACK_TRUE_VALUE"]] : "" )?>">
                                        ...
                                        <?if( is_array( $arProfile["XMLDATA"][$id]["STACK_FALSE"] ) && !empty( $arProfile["XMLDATA"][$id]["STACK_FALSE"] ) ){
                                            foreach( $arProfile["XMLDATA"][$id]["STACK_FALSE"] as $stackFalseId => $arStackFalse ){?>
                                                <div class="stack-data-item" data-id="<?=$stackFalseId?>" style="margin: 10px 0px 0px 0px;">
                                                    ...
                                                    <input class="field-block-stack <?=$hideStackFieldFalseBlock?>" readonly="readonly" name="PROFILE[XMLDATA][<?=$id?>][STACK_FALSE][<?=$stackFalseId?>][STACK_FALSE_VALUE_SHOW]" data-id="<?=$id?>" type="text" title="<?=$arLinearFieldsList[$arStackFalse["STACK_FALSE_VALUE"]];?>" value="<?=( isset( $arLinearFieldsList[$arStackFalse["STACK_FALSE_VALUE"]] ) ? $arLinearFieldsList[$arStackFalse["STACK_FALSE_VALUE"]] : GetMessage( "DATA_EXPORTPROPLUS_NE_VYBRANO" ) );?>" />
                                                    <span class="field-edit-stack fieldselecter <?=$hideStackFieldFalseBlock?>" onclick="ShowFieldsList( 'field-block-stack-', '<?=$id?>', '<?=$stackFalseId?>', '<?=$arStackTrue["STACK_FALSE_VALUE"]?>' )" title="<?=GetMessage( "DATA_EXPORTPROPLUS_FIELD_LIST_DATA_SELECT" );?>"></span>

                                                    <div id="field-block-stack-<?=$id?>-<?=$stackFalseId?>-list" class="fields-popup-list" style="display: none;">
                                                        <input onkeyup="FilterFieldsList( this, 'field-block-stack-<?=$id?>-<?=$stackFalseId?>-list' )" placeholder="<?=GetMessage( "DATA_EXPORTPROPLUS_MARKET_CATEGORY_DATA_WINDOW_PLACEHOLDER" );?>" value="<?=( isset( $arLinearFieldsList[$arStackFalse["STACK_FALSE_VALUE"]] ) ? $arLinearFieldsList[$arStackFalse["STACK_FALSE_VALUE"]] : "" )?>">
                        ...
                        <div style="margin: 10px 0px 10px 15px;">
                            <span id="hint_EXPORTPROPLUS_FIELDSET_REQUIRED"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_REQUIRED' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_REQUIRED_HELP" )?>' );</script>
							...
							<?if(CModule::includeModule('catalog')):?>
								<span id="hint_EXPORTPROPLUS_FIELDSET_CONDITION"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_CONDITION' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONDITION_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_FORCE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_FORCE' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_FORCE_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_ROWFORCE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_ROWFORCE' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_DELETE_ONEMPTY_ROWFORCE_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_URL_ENCODE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_URL_ENCODE' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_URL_ENCODE_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_CONVERT_CASE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_CONVERT_CASE' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONVERT_CASE_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_HTML_ENCODE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_HTML_ENCODE' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_HTML_ENCODE_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_HTML_ENCODE_CUT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_HTML_ENCODE_CUT' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_HTML_ENCODE_CUT_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_HTML_TO_TXT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_HTML_TO_TXT' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_HTML_TO_TXT_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_SKIP_UNTERM_ELEMENT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_SKIP_UNTERM_ELEMENT' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_SKIP_UNTERM_ELEMENT_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_TO_STRING"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_TO_STRING' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_MULTIPROP_TO_STRING_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_DIVIDER"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_DIVIDER' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_MULTIPROP_DIVIDER_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_LIMIT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_LIMIT' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_MULTIPROP_LIMIT_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_FORMAT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_MULTIPROP_FORMAT' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_MULTIPROP_FORMAT_HELP" )?>' );</script>
                            <label for="PROFILE[XMLDATA][<?=$id?>][MULTIPROP_FORMAT]"><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_MULTIPROP_FORMAT" )?></label><br/>
                            <input type="text" name="PROFILE[XMLDATA][<?=$id?>][MULTIPROP_FORMAT]" value="<?=$multiPropFormat;?>" />

                            <div style="height: 5px;">&nbsp;</div>

                            <span id="hint_EXPORTPROPLUS_FIELDSET_TEXT_LIMIT"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_TEXT_LIMIT' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_TEXT_LIMIT_HELP" )?>' );</script>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_ROUND_PRECISION"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_ROUND_PRECISION' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ROUND_PRECISION_HELP" )?>' );</script>
                            <label for="PROFILE[XMLDATA][<?=$id?>][ROUND][PRECISION]"><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_ROUND_PRECISION" )?></label><br/>
                            ...
                            <div class="bitrix_round_mode" data-dependent="price" <?if( stripos( $field["VALUE"], "PRICE" ) !== false ):?><?else:?>style="display: none"<?endif;?>>
                                <div style="height: 5px;">&nbsp;</div>
                                <span id="hint_EXPORTPROPLUS_FIELDSET_BITRIX_ROUND_MODE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_BITRIX_ROUND_MODE' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_BITRIX_ROUND_MODE_HELP" )?>' );</script>
                                <input type="checkbox" name="PROFILE[XMLDATA][<?=$id?>][BITRIX_ROUND_MODE]" <?=$bitrixRoundMode?> value="Y">
                                <label for="PROFILE[XMLDATA][<?=$id?>][BITRIX_ROUND_MODE]"><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_BITRIX_ROUND_MODE" )?></label>
                            </div>
                            ...
                            <div class="minimum_offer_price" data-dependent="price" <?if( stripos( $field["VALUE"], "PRICE" ) !== false ):?><?else:?>style="display: none"<?endif;?>>
                                <div style="height: 5px;">&nbsp;</div>
                                <span id="hint_EXPORTPROPLUS_FIELDSET_MINIMUM_OFFER_PRICE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_MINIMUM_OFFER_PRICE' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_MINIMUM_OFFER_PRICE_HELP" )?>' );</script>
                                ...
                                <label for="PROFILE[XMLDATA][<?=$id?>][MINIMUM_OFFER_PRICE]"><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_MINIMUM_OFFER_PRICE" )?></label>

                                <div class="minimum_offer_price_code" <?if( strlen( $calculateMinimum ) ):?><?else:?>style="display: none"<?endif;?>>
                                    <div style="height: 5px;">&nbsp;</div>
                                    <span id="hint_EXPORTPROPLUS_FIELDSET_MINIMUM_OFFER_PRICE_CODE"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_MINIMUM_OFFER_PRICE_CODE' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_MINIMUM_OFFER_PRICE_CODE_HELP" )?>' );</script>
                                    <label for="PROFILE[XMLDATA][<?=$id?>][MINIMUM_OFFER_PRICE_CODE]"><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_MINIMUM_OFFER_PRICE_CODE" )?></label>
                                    <div>
                            ...
                            <span id="hint_EXPORTPROPLUS_FIELDSET_CONVERT_DATA"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_CONVERT_DATA' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONVERT_DATA_HELP" )?>' );</script>
                            <label for="PROFILE[XMLDATA][<?=$id?>][CONVERT_DATA]"><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONVERT_DATA" )?></label><br/><br/>
                            <table id="fieldset-convert-fieldset-container<?=$id?>" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td width="50%">
                                        <span id="hint_EXPORTPROPLUS_FIELDSET_CONVERT_DATA_REGEXP"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_EXPORTPROPLUS_FIELDSET_CONVERT_DATA_REGEXP' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONVERT_DATA_REGEXP_HELP" )?>' );</script>
                                        <label for="PROFILE[XMLDATA][<?=$id?>][CONVERT_DATA_REGEXP]"><?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONVERT_DATA_REGEXP" )?></label>
                                    </td>
                            ...
                            <div data-row-id="<?=$id?>" style="margin: 0 auto; padding: 10px; text-align: center;">
                                <button class="adm-btn" onclick="FieldsetConvertFieldsetAdd( this ); return false;">
                                    <?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONVERT_CONDITION_ADD" )?>
                                </button>
                            </div>
                        </div>
...
<tr>
    <td colspan="2" align="center" id="fieldset-item-add-button">
        <button class="adm-btn" onclick="FieldsetAdd( this ); return false;">
            <?=GetMessage( "DATA_EXPORTPROPLUS_FIELDSET_CONDITION_ADD" );?>
        </button>
    </td>
</tr>