...
<tr class="heading" align="center">
    <td colspan="2"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_GENERAL" )?></b></td>
</tr>
<tr>
    <tr>
        <td width="40%" class="adm-detail-content-cell-l">
            <span id="hint_PROFILE[ACTIVE]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[ACTIVE]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_ACTIVE_HELP" )?>' );</script>
            <label for="PROFILE[ACTIVE]"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_ACTIVE" )?></label>
        </td>
        <td width="60%" class="adm-detail-content-cell-r">
            <input type="checkbox" name="PROFILE[ACTIVE]" <?=$activeChecked?> value="Y" />
            <i><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_ACTIVE_DESC" )?></i>
        </td>
    </tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[NAME]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[NAME]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_NAME_HELP" )?>' );</script>
        <label for="PROFILE[NAME]"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_NAME" )?></b></label>
    </td>
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[CODE]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[CODE]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_CODE_HELP" )?>' );</script>
        <label for="PROFILE[CODE]"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_CODE" )?></b> </label>
    </td>
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[DESCRIPTION]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[DESCRIPTION]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_DESCRIPTION_HELP" )?>' );</script>
        <label for="PROFILE[DESCRIPTION]"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_DESCRIPTION" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[SHOPNAME]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[SHOPNAME]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_SHOPNAME_HELP" )?>' );</script>
        <label for="PROFILE[SHOPNAME]"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_SHOPNAME" )?></b></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[COMPANY]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[COMPANY]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_COMPANY_HELP" )?>' );</script>
        <label for="PROFILE[COMPANY]"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_COMPANY" )?></b></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[DOMAIN_NAME]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[DOMAIN_NAME]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_DOMAIN_NAME_HELP" )?>' );</script>
        <label for="PROFILE[DOMAIN_NAME]"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_DOMAIN_NAME" )?></b></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[LID]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[LID]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_SITE_HELP" )?>' );</script>
        <label for="PROFILE[LID]"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_SITE" )?></b></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r"><?=CLang::SelectBox( "PROFILE[LID]", $arProfile["LID"], "", "" )?></td>
</tr>
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[ENCODING]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[ENCODING]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_ENCODING_HELP" )?>' );</script>
        <label for="PROFILE[ENCODING]"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_ENCODING" )?></b></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr class="heading" align="center">
    <td colspan="2"><b><?=GetMessage( "DATA_EXPORTPROPLUS_IBLOCK_SECTION_SHOW" )?></b></td>
</tr>
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[VIEW_CATALOG]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[VIEW_CATALOG]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_ONLY_CATALOG_HELP" )?>' );</script>
        <label for="PROFILE[VIEW_CATALOG]"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_ONLY_CATALOG" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
        <input type="checkbox" name="PROFILE[VIEW_CATALOG]" <?=$bViewCatalogOnly?> value="Y" />
        <i><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_ONLY_CATALOG_DESC" )?></i>
    </td>
</tr>
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[CHECK_INCLUDE]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[CHECK_INCLUDE]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_CHECK_INCLUDE_HELP" )?>' );</script>
        <label for="PROFILE[CHECK_INCLUDE]"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_CHECK_INCLUDE" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[USE_SKU]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[USE_SKU]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_SKU_HELP" )?>' );</script>
        <label for="PROFILE[USE_SKU]"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_SKU" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[USE_IBLOCK_CATEGORY]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[USE_IBLOCK_CATEGORY]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_IBLOCK_CATEGORY_HELP" )?>' );</script>
        <label for="PROFILE[USE_IBLOCK_CATEGORY]"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_IBLOCK_CATEGORY" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[USE_IBLOCK_PRODUCT_CATEGORY]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[USE_IBLOCK_PRODUCT_CATEGORY]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_IBLOCK_PRODUCT_CATEGORY_HELP" )?>' );</script>
        <label for="PROFILE[USE_IBLOCK_PRODUCT_CATEGORY]"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_IBLOCK_PRODUCT_CATEGORY" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<tr class="heading" align="center">
    <td colspan="2"><b><?=GetMessage( "DATA_EXPORTPROPLUS_IBLOCK_SELECT" )?></b></td>
</tr>
<tr id="tr_iblock_showtype">
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[SETUP][IBLOCK_SHOWTYPE]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[SETUP][IBLOCK_SHOWTYPE]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_IBLOCK_SHOWTYPE_HELP" )?>' );</script>
        <label for="PROFILE[SETUP][IBLOCK_SHOWTYPE]"><?=GetMessage( "DATA_EXPORTPROPLUS_IBLOCK_SHOWTYPE" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
        <?foreach( $obProfileUtils->GetIblockShowType() as $type ){
            ...
            <input type="radio" name="PROFILE[SETUP][IBLOCK_SHOWTYPE]" value="<?=$type?>" <?=$checked?> onchange="ChangeIblockShowType( this.value )"><?=GetMessage( "DATA_EXPORTPROPLUS_IBLOCK_SHOWTYPE_".strtoupper( $type ) )?>
        <?}?>
    </td>
</tr>
...
<tr class="heading" align="center">
    <td colspan="2"><b><?=GetMessage( "DATA_EXPORTPROPLUS_IBLOCK_AUTOFILL_PROPS" )?></b></td>
</tr>
<tr>
    <td width="40%" class="adm-detail-content-cell-l">
        <span id="hint_PROFILE[USE_AUTOFILL_PROPS]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[USE_AUTOFILL_PROPS]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_AUTOFILL_PROPS_HELP" )?>' );</script>
        <label for="PROFILE[USE_AUTOFILL_PROPS]"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_AUTOFILL_PROPS" )?></label>
    </td>
    <td width="60%" class="adm-detail-content-cell-r">
...
<?if( $bUseIblockAutofillProps ){
    ...
    <tr>
        <td width="40%" class="adm-detail-content-cell-l" valign="top">
            <span id="hint_PROFILE[USE_AUTOFILL_SELECT]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[USE_AUTOFILL_SELECT]' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_AUTOFILL_SELECT_HELP" )?>' );</script>
            <label for="PROFILE[USE_AUTOFILL_SELECT]"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_USE_AUTOFILL_SELECT" )?></label>
        </td>
        <td width="60%" class="adm-detail-content-cell-r">
    ...
    <tr>
        <td width="40%" class="adm-detail-content-cell-l">
            <span id="hint_DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_SET"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_SET' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_SET_HELP" )?>' );</script>
            <label for="STEP1_AUTOFILL_SETTINGS_SET"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_SET" )?></b> </label>
        </td>
        <td width="60%" class="adm-detail-content-cell-r">
            <a class="adm-btn adm-btn-save" onclick="AutofillSettingsSet( '<?=$arProfile["ID"];?>' );"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_SET_BUTTON" )?></a>
        </td>
    </tr>
    <tr>
        <td width="40%" class="adm-detail-content-cell-l">
            <span id="hint_DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_RESET"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_RESET' ), '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_RESET_HELP" )?>' );</script>
            <label for="STEP1_AUTOFILL_SETTINGS"><b><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_RESET" )?></b> </label>
        </td>
        <td width="60%" class="adm-detail-content-cell-r">
            <a class="adm-btn adm-btn-save" onclick="if( confirm( '<?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_CONFIRM" )?>' ) ){ AutofillSettingsReset( '<?=$arProfile["ID"];?>' ); }"><?=GetMessage( "DATA_EXPORTPROPLUS_STEP1_AUTOFILL_SETTINGS_RESET_BUTTON" )?></a>
        </td>
    </tr>
<?}?>