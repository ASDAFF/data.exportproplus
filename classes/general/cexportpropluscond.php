    ...
    public static function GetLogic($arOperators = false)
    {
        $arOperatorsList = array(
            ...
            BT_COND_LOGIC_GR => array(
                ...
                'OP' => array(
                    'N' => '#FIELD# > #VALUE#',
                    'Y' => 'CDataGlobalCondCtrl::LogicGreat(#FIELD#, #VALUE#)'
                ),
                'VALUE' => 'Great',
            ...
            BT_COND_LOGIC_LS => array(
                ...
                'OP' => array(
                    'N' => '#FIELD# < #VALUE#',
                    'Y' => 'CDataGlobalCondCtrl::LogicLess(#FIELD#, #VALUE#)'
                ),
                'VALUE' => 'Less',
            ...
            BT_COND_LOGIC_EGR => array(
                ...
                'OP' => array(
                    'N' => '#FIELD# >= #VALUE#',
                    'Y' => 'CDataGlobalCondCtrl::LogicEqualGreat(#FIELD#, #VALUE#)'
                ),
                'VALUE' => 'EqGr',
            ...
            BT_COND_LOGIC_ELS => array(
                ...
                'OP' => array(
                    'N' => '#FIELD# <= #VALUE#',
                    'Y' => 'CDataGlobalCondCtrl::LogicEqualLess(#FIELD#, #VALUE#)'
                ),
                'VALUE' => 'EqLs',
            ...
            BT_COND_LOGIC_CONT => array(
                ...
                'OP' => array(
                    ...
                    'Y' => 'CDataGlobalCondCtrl::LogicContain(#FIELD#, #VALUE#)'
                ),
                'PARENT' => ' || ',
                'MULTI_SEP' => ' || ',
                'VALUE' => 'Contain',
            ...
            BT_COND_LOGIC_NOT_CONT => array(
                ...
                'OP' => array(
                    'N' => 'false === strpos(#FIELD#, #VALUE#)',
                    'Y' => 'CDataGlobalCondCtrl::LogicNotContain(#FIELD#, #VALUE#)'
                ),
                'PARENT' => ' && ',
                'MULTI_SEP' => ' && ',
                'VALUE' => 'NotCont',
...
class CDataGlobalCondCtrlComplex extends CDataGlobalCondCtrl
{
    public static function GetControlDescr()
    {
        $strClassName = get_called_class();
...
class CDataGlobalCondCtrlAtoms extends CDataGlobalCondCtrl
{
    /**
     * @return array|bool
     */
...
class CDataGlobalCondCtrlGroup extends CDataGlobalCondCtrl
{
    public static function GetControlDescr()
    {
        $className = get_called_class();
...
class CDataCatalogCondCtrl extends CDataGlobalCondCtrl
{
}

class CDataCatalogCondCtrlComplex extends CDataGlobalCondCtrlComplex
{
}

class CDataCatalogCondCtrlGroup extends CDataGlobalCondCtrlGroup
{
    public static function GetControlDescr()
    {
...
class CDataCatalogCondCtrlIBlockFields extends CDataCatalogCondCtrlComplex
{
    public static function GetControlDescr()
    {
        $description = parent::GetControlDescr();
...
class CDataCatalogCondCtrlIBlockProps extends CDataCatalogCondCtrlComplex
{
    public static function GetControlDescr()
    {
        $description = parent::GetControlDescr();
...
class CDataCatalogCondTree extends CDataGlobalCondTree
{
    public function __construct()
    {
        parent::__construct();
