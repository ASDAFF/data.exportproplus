...
class CExportproplusProfileDB{
    ...
    private $profileTableName = "data_exportproplus_profile";
    private $dataTableName = "data_exportproplus_profile_data";
    private $toolsTableName = "data_exportproplus_profile_tools";
