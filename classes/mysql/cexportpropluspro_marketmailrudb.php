...
class CExportproplusMarketMailruDB
{
    private $tableName = "data_exportproplus_market_mailru";
    ...
    public function GetMarketList( $marketId )
    {
        ...
        if( is_array( $marketTiuCategory ) && !empty( $marketTiuCategory ) ){
            ...
            array_walk( $arMarketCategory, "CDataExportproStringProcess::DataArrayTrimFunc" );
        }
