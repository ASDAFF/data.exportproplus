...
if (\Bitrix\Main\Loader::includeModule('data.core')) {
    ...
    $GLOBALS['DATA_' . $_565738227 . '_AUTOLOAD_CLASSES'] =& $_288983588;
...
$arClasses = array(
    ...
    'CDataGlobalCondCtrl' => 'classes/general/cexportpropluscond.php',
    'CDataGlobalCondCtrlComplex' => 'classes/general/cexportpropluscond.php',
    'CDataGlobalCondCtrlAtoms' => 'classes/general/cexportpropluscond.php',
    'CDataGlobalCondCtrlGroup' => 'classes/general/cexportpropluscond.php',
    'CDataGlobalCondTree' => 'classes/general/cexportpropluscond.php',
    'CDataCatalogCondCtrl' => 'classes/general/cexportpropluscond.php',
    'CDataCatalogCondCtrlComplex' => 'classes/general/cexportpropluscond.php',
    'CDataCatalogCondCtrlGroup' => 'classes/general/cexportpropluscond.php',
    'CDataCatalogCondCtrlIBlockFields' => 'classes/general/cexportpropluscond.php',
    'CDataCatalogCondCtrlIBlockProps' => 'classes/general/cexportpropluscond.php',
    'CDataCatalogCondTree' => 'classes/general/cexportpropluscond.php',

    'CDataExportproplusCatalog' => 'classes/general/cexportproplusfilter.php',
    'CDataExportproplusPrices' => 'classes/general/cexportproplusfilter.php',
    'CDataExportproplusProps' => 'classes/general/cexportproplusfilter.php',
    'CDataExportproplusCatalogCond' => 'classes/general/cexportproplusfilter.php',

    'CDataExportproplusLog' => 'classes/general/cexportpropluslog.php',
    'DataExportproplusSession' => 'classes/general/cexportproplussession.php',
    'CDataExportproplusUrlRewrite' => 'classes/general/cexportproplusurlrewrite.php',

    'CDataExportproplusTools' => 'classes/general/cexportproplustools.php',
    'CDataExportproplusStringProcess' => 'classes/general/cexportproplustools.php',
    'CDataExportproplusMarketCategories' => 'classes/general/cexportproplustools.php',

    'CDataExportproplusExport' => 'classes/general/cexportproplusexport.php',
    ...
    'CDataExportproplusVkTools' => 'classes/general/cexportproplusvktools.php',
    'CDataExportproplusFbTools' => 'classes/general/cexportproplusfbtools.php',
    'CDataExportproplusOkTools' => 'classes/general/cexportproplusoktools.php',
    'CDataExportproplusInstagramTools' => 'classes/general/cexportproplusinstagramtools.php',
);

CModule::AddAutoloadClasses('data.exportproplus', $arClasses);

class CDataExportproplusMenu
{
    public function OnBuildGlobalMenu(&$aGlobalMenu, &$aModuleMenu)
    {
        global $USER, $APPLICATION, $adminMenu, $adminPage;
        if (\Bitrix\Main\Config\Option::get('data.exportproplus', 'disable_old_core') == 'Y') {
            return;
        }
        if (is_array($adminMenu->aGlobalMenu) && key_exists('global_menu_data', $adminMenu->aGlobalMenu)) {
            return;
        }
        $gName = COption::GetOptionString('data.exportproplus', 'datamenu_groupname');
        if (strlen(trim($gName)) <= 0) {
            $gName = GetMessage('DATAMENU_GROUPNAME_DEFAULT');
        }
        $aMenu = array(
            'menu_id' => 'data',
            'sort' => 150,
...
class CDataExportproplusElement
{
    public $_1758607422 = null;
    public $_1427474118 = 2;
    public $_1480025059 = true;
    public $_1418746172;
    public $_1184264429 = "data.exportproplus";
    public $_1418013741 = 50;
    public $_15755796 = array();
    ...
    public function __construct($_1758607422)
    {
        global $APPLICATION;
        ...
        $this->_1427474118 = CModule::IncludeModuleEx($this->_1184264429);
        if ($this->_1427474118 == 1) {
            $this->_1480025059 = false;
        }
        $this->_1418746172 = 50;
        $this->_1758607422 = $_1758607422;
        $this->_1232139345 = new CExportproplusProfileDB();
        $this->_1735599212 = new CExportproplusProfile();
        $this->_1758607422['PROFILE_CATEGORIES'] = $this->_1735599212->GetSections($this->_1758607422['IBLOCK_ID'], $this->_1758607422['CHECK_INCLUDE'] == 'Y', true);
        $this->_1500291233 = new CDataExportproplusVkTools($_1758607422);
        $this->_2021795626 = false;
        if (($this->_1758607422['TYPE'] == 'ozon_api') || ($this->_1758607422['TYPE'] == 'vk_trade') || ($this->_1758607422['TYPE'] == 'fb_trade') || ($this->_1758607422['TYPE'] == 'instagram_trade') || ($this->_1758607422['TYPE'] == 'ok_trade')) {
            $this->_2021795626 = true;
        }
        if ($_1758607422['TYPE'] == 'ozon_api') {
            $this->_112131147 = new CExportproplusOzon($_1758607422['OZON_APPID'], $_1758607422['OZON_APPKEY']);
        }
        $this->_360787538 = new CDataExportproplusOkTools($_1758607422);
        $this->_488061881 = new CDataExportproplusInstagramTools($_1758607422);
        $this->_116831045 = new CDataExportproplusFb($_1758607422);
        if (intval($this->_1758607422['SETUP']['EXPORT_STEP']) > 0) $this->_1418013741 = $this->_1758607422['SETUP']['EXPORT_STEP'];
        ...
        $this->_940439577 = new CDataExportproplusLog($this->_1758607422['ID']);
        $this->_317570903 = 'Y-m-dTh:i:s±h:i';
        $_1136836731 = CDataExportproplusTools::GetStringCharset($this->_317570903);
        if ($_1136836731 == 'cp1251') {
            $this->_317570903 = $APPLICATION->ConvertCharset($this->_317570903, 'windows-1251', 'UTF-8');
        }
        $_827311422 = ($this->_1758607422['DATEFORMAT'] == $this->_317570903) ? CDataExportproplusTools::GetYandexDateTime(date('d.m.Y H:i:s')) : date(str_replace('_', ' ', $this->_1758607422['DATEFORMAT']), time());
        $this->_12750998 = array('#ENCODING#' => $this->_1330835753[$this->_1758607422['ENCODING']], '#SHOP_NAME#' => $this->_1758607422['SHOPNAME'], '#COMPANY_NAME#' => $this->_1758607422['COMPANY'], '#SITE_URL#' => $this->_1758607422['SITE_PROTOCOL'] . '://' . $this->_1758607422['DOMAIN_NAME'], '#PROFILE_DESCRIPTION#' => $this->_1758607422['DESCRIPTION'], '#DATE#' => $_827311422,);
        $this->_1294848254 = CDataExportproplusTools::GetProcessPriceId($this->_1758607422);
        if (($this->_1758607422['TYPE'] == 'tiu_standart') || ($this->_1758607422['TYPE'] == 'tiu_standart_vendormodel')) {
            $_514197488 = new CExportproplusMarketTiuDB();
        } elseif ($this->_1758607422['TYPE'] == 'ua_prom_ua') {
            $_514197488 = new CExportproplusMarketPromuaDB();
        } elseif ($this->_1758607422['TYPE'] == 'mailru' || $this->_1758607422['TYPE'] == 'mailru_clothing') {
            $_514197488 = new CExportproplusMarketMailruDB();
        } else {
            $_514197488 = new CExportproplusMarketDB();
        }
        $this->_2046460632 = $_514197488->GetMarketList($this->_1758607422['MARKET_CATEGORY']['CATEGORY']);
    }
    ...
    public function CalcProcessXMLLoadingByOneProduct()
    {
        ...
        $_243855875 = DataExportproplusSession::GetSession($this->_1758607422['ID']);
        $_243855875['EXPORTPROPLUS']['LOG'][$this->_1758607422['ID']]['STEPS'] = $this->_1480025059 ? 1 : $_1461419195->_1235249829;
        DataExportproplusSession::SetSession($this->_1758607422['ID'], $_243855875);
        while ($_485935950 = $_1461419195->GetNextElement()) {
            $_11678077 = array();
            $_1799584481 = $this->__705054251($_485935950);
            if (!$_1799584481) continue;
            if ($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') {
                $_982944057 = $_1799584481['IBLOCK_ID'];
            } elseif ($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') {
                $_982944057 = $_1799584481['IBLOCK_PRODUCT_SECTION_ID'];
            } else {
                $_982944057 = $_1799584481['IBLOCK_SECTION_ID'];
            }
            if (CDataExportproplusTools::isVariant($this->_1758607422, $_982944057)) {
                if (!$_1799584481['SKIP']) {
        ...
        CDataExportproplusTools::SaveCurrencies($this->_1758607422, $this->_1364486914);
    ...
    {
        if ($_1634919591 == 1) {
            $this->_940439577->Init($this->_1758607422);
        ...
        $_275052511 = GetMessage('DATA_EXPORTPROPLUS_A_AA_A');
        preg_match_all('/.*(<[\w\d_-]+).*(#[\w\d_-]+:*[\w\d_-]+#).*(<\/.+>)/', $this->_1758607422['OFFER_TEMPLATE'], $this->_547888680);
        preg_match_all('/(#[\w\d_-]+:*[\w\d_-]+#)/', $this->_1758607422['OFFER_TEMPLATE'], $this->_547888680['ALL_TAGS']);
        ...
        foreach ($this->_1758607422['XMLDATA'] as $_1639684675) {
            ...
            if ($_1639684675['EVAL_FILTER']) {
                preg_match_all('/.*?PROPERTY_(\d+)|(CATALOG_PRICE_[\d]+_WD|CATALOG_PRICE_[\d]+_D).*?/', $this->_1758607422['EVAL_FILTER'], $_1263637527);
        ...
        $_1897466041 = GetModuleEvents('data.exportproplus', 'OnBeforePropertiesSelect');
        $_1892215348 = array();
        while ($_257451012 = $_1897466041->Fetch()) {
            ExecuteModuleEventEx($_257451012, array(array('ID' => $this->_1758607422['ID'], 'CODE' => $this->_1758607422['CODE'], 'NAME' => $this->_1758607422['NAME']), &$_1892215348));
        }
        ...
        $_1525266428 = str_replace('-', '_', $this->_1758607422['VARIANT']['PRICE']);
        ...
        if (is_array($this->_1758607422['VARIANT']) && !empty($this->_1758607422['VARIANT'])) {
            foreach ($this->_1758607422['VARIANT'] as $_1043938606 => $_365814225) {
        ...
        $_12820925 = array('IBLOCK_ID' => $_954971976, 'SECTION_ID' => $this->_1758607422['CATEGORY'],);
        if ($this->_1758607422['CHECK_INCLUDE'] != 'Y') {
            $_12820925['INCLUDE_SUBSECTIONS'] = 'Y';
        }
        $_1671974018 = array('nPageSize' => $this->_1418013741, 'iNumPage' => $_1634919591);
    ...
    protected function PrepareIBlock()
    {
        ...
        if ((($this->_1758607422['USE_SKU'] == 'Y') || ($this->_1758607422['TYPE'] == 'advantshop')) && (CDataExportproplusTools::ArrayValidate($this->_1758607422['IBLOCK_ID']))) {
            foreach ($this->_1758607422['IBLOCK_ID'] as $_1230546977) {
                if ($this->_1768427482) {
                    if ($_1577003840 = CCatalog::GetByID($_1230546977)) {
                        if (intval($_1577003840['PRODUCT_IBLOCK_ID']) > 0 && in_array($_1577003840['PRODUCT_IBLOCK_ID'], $this->_1758607422['IBLOCK_ID'])) $_2129797772[] = $_1577003840['IBLOCK_ID'];
                        if (intval($_1577003840['OFFERS_IBLOCK_ID']) > 0) $this->_2078735835[$_1577003840['IBLOCK_ID']] = $_1577003840;
                    }
                }
            }
        }
        return array_diff((is_array($this->_1758607422['IBLOCK_ID']) ? $this->_1758607422['IBLOCK_ID'] : array()), $_2129797772);
    }
    ...
    private function __705054251($_485935950, $_851873695 = false, $_409953385 = false, $_1768420642 = false, $_1030859019 = array(), &$_1658004309 = array())
    {
        ...
        if ($this->_1768427482) {
            ...
            if ($_623193173['SETUP']['VALIDATE_CONDITIONS'] == 'Y') {
                ...
                if ($_1329090688 !== $_1100111501) {
                    $_1543470442 = new CDataExportproplusCatalogCond();
                    CDataExportproplusProps::$_463054691 = CExportproplusProfile::PrepareIBlock($_623193173['IBLOCK_ID'], $_623193173['USE_SKU']);
            ...
            if (!CDataExportproplusTools::CheckCondition($_1799584481, $_623193173['EVAL_FILTER'])) {
        ...
        if ($_409953385) {
            ...
            $_1108326879 = $this->_1758607422['OFFER_TEMPLATE'];
        ...
        if (empty($_1063913501[$_1799584481['IBLOCK_ID']])) {
            ...
            while ($_1617843728 = $_683024549->GetNext(false, false)) {
                if (intval($_1617843728['PICTURE'])) {
                    $_1617843728['PICTURE'] = CDataExportproplusTools::GetFilePath($_1617843728['PICTURE']);
                }
                if (intval($_1617843728['DETAIL_PICTURE'])) {
                    $_1617843728['DETAIL_PICTURE'] = CDataExportproplusTools::GetFilePath($_1617843728['DETAIL_PICTURE']);
                }
        ...
        if (!$_409953385) {
            $_1250329899 = array();
            if ($this->_1758607422['EXPORT_PARENT_CATEGORIES_TO_OFFER'] == 'Y') {
                $_1250329899 = $_1799584481['SECTION_PARENT_ID'];
                if ($this->_1758607422['EXPORT_OFFER_CATEGORIES_TO_OFFER'] == 'Y') {
            ...
            } elseif ($this->_1758607422['EXPORT_OFFER_CATEGORIES_TO_OFFER'] == 'Y') {
        ...
        foreach ($this->_1758607422['XMLDATA'] as $_29195840 => $_1639684675) {
            ...
            if ($_579528835) {
                $_1777028725 = (CDataExportproplusTools::CheckCondition($_1799584481, $_1639684675['EVAL_FILTER']) == true);
            }
            if ($_579528835 && !$_1777028725) {
                    ...
                    if ($_1639684675['TYPE'] == 'composite') {
                        ...
                        foreach ($_1639684675['COMPOSITE_FALSE'] as $_628180431 => $_111434879) {
                            ...
                            if ($_111434879['COMPOSITE_FALSE_TYPE'] == 'const') {
                                $_240357056 .= CDataExportproplusTools::RoundNumber($_111434879['COMPOSITE_FALSE_CONTVALUE'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                    ...
                                    switch (count($_47247544)) {
                                        case 1:
                                            ...
                                            if (strpos($_111434879['COMPOSITE_FALSE_VALUE'], '.') !== false) {
                                                ...
                                                unset($_1117656864);
                                                $_647344568 = CDataExportproplusTools::RoundNumber($_1438955011, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            } else {
                                                $_647344568 = CDataExportproplusTools::RoundNumber($_1799584481[$_111434879['COMPOSITE_FALSE_VALUE']], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                            $_1799584481 = $_1642182436;
                                            break;
                                        case 2:
                                            ...
                                            if (strpos($_47247544[1], '_CURRENCY') > 0) {
                                                ...
                                                $_647344568 = CDataExportproplusTools::RoundNumber($_647344568, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                if (is_array($_851873695)) {
                                                    $_480208289 = $_647344568;
                                                }
                                                if ($this->_1758607422['CURRENCY']['CONVERT_CURRENCY'] == 'Y') {
                                                    if ($this->_1758607422['CURRENCY'][$_1284853936]['CHECK']) {
                                                        $_615351990 = $this->_1758607422['CURRENCY'][$_1284853936]['CONVERT_TO'];
                                                ...
                                                if ($this->_1758607422['CURRENCY']['CONVERT_CURRENCY'] == 'Y') {
                                                    if ($this->_1758607422['CURRENCY'][$_1284853936]['CHECK']) {
                                                        $_615351990 = $this->_1758607422['CURRENCY'][$_1284853936]['CONVERT_TO'];
                                                        if ($this->_1758607422['CURRENCY'][$_1284853936]['RATE'] == 'SITE') {
                                                            $_647344568 = CDataExportproplusTools::RoundNumber(CCurrencyRates::ConvertCurrency($_1799584481['CATALOG_' . $_47247544[1]], $this->_1758607422['CURRENCY'][$_1284853936]['CONVERT_FROM'], $_615351990), $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE'], 0);
                                                            if (is_array($_851873695)) {
                                                                $_480208289 = $_647344568;
                                                            }
                                                        } else {
                                                            $_647344568 = CDataExportproplusTools::RoundNumber($_647344568 * $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_1284853936]['RATE'] / $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_615351990]['RATE'] / $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_1284853936]['RATE_CNT'] * $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_615351990]['RATE_CNT'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE'], 0);
                                                            if (is_array($_851873695)) {
                                                                $_480208289 = $_647344568;
                                                            }
                                                        }
                                                ...
                                                if ($this->_1758607422['CURRENCY'][$_1284853936]['CHECK']) {
                                                    $_647344568 += $_647344568 * floatval($this->_1758607422['CURRENCY'][$_1284853936]['PLUS']) / 100;
                                                    $_647344568 = CDataExportproplusTools::RoundNumber($_647344568, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                    if (is_array($_851873695)) {
                                                        $_480208289 = $_647344568;
                                                    }
                                            ...
                                            if (stripos($_47247544[1], '_WD') !== false) {
                                                if (in_array('PRICE_' . $_1799584481['CATALOG_' . $_47247544[1] . '_PRICEID'] . '_WD', $this->_1931809273) || in_array('PRICE_' . $_1799584481['CATALOG_' . $_47247544[1] . '_PRICEID'] . '_D', $this->_1931809273)) {
                                                    $_1432753308 = CCatalogDiscount::GetDiscountByPrice($_1799584481['CATALOG_' . $_47247544[1] . '_ID'], $USER->GetUserGroupArray(), 'N', $this->_1758607422['LID']);
                                            ...
                                            if ($_1639684675['BITRIX_ROUND_MODE'] == 'Y') {
                                                $_647344568 = CDataExportproplusTools::BitrixRoundNumber($_647344568, $_47247544[1]);
                                            } else {
                                                $_647344568 = CDataExportproplusTools::RoundNumber($_647344568, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                            if (is_array($_851873695)) {
                                        ...
                                        case 3:
                                            ...
                                            if (($_47247544[0] == $_1799584481['IBLOCK_ID']) || ($_47247544[0] == $_851873695['IBLOCK_ID'])) {
                                                if ($this->_2078735835[$_47247544[0]]['OFFERS_PROPERTY_ID'] == $_47247544[2]) {
                                                    $_1799584481["PROPERTY_{$_47247544[2]}_DISPLAY_VALUE"] = CDataExportproplusTools::RoundNumber($_1799584481["PROPERTY_{$_47247544[2]}_VALUE"][0], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                }
                                                if ($this->_1758607422['XMLDATA']["{$_1639684675['CODE']}"]['PROCESS_LOGIC'] == 'N') {
                                                ...
                                                if (is_array($_212220634)) {
                                                    $_55309008 = CDataExportproplusTools::ParseMultiproFormat($_212220634, $this->_1758607422, $_1639684675['CODE']);
                                                    $_212220634 = (is_array($_55309008) && !empty($_55309008)) ? $_55309008 : $_212220634;
                                                    $_647344568 = array();
                                                    foreach ($_212220634 as $_32014025) {
                                                        if (intval($this->_1758607422['XMLDATA'][$_1639684675['CODE']]['MULTIPROP_LIMIT']) > 0) {
                                                            if (count($_647344568) < $this->_1758607422['XMLDATA'][$_1639684675['CODE']]['MULTIPROP_LIMIT']) {
                                                                $_647344568[] = CDataExportproplusTools::RoundNumber($_32014025, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                            }
                                                        } else {
                                                            $_647344568[] = CDataExportproplusTools::RoundNumber($_32014025, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                        }
                                                    ...
                                                    $_647344568 = CDataExportproplusTools::RoundNumber($_212220634, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                }
                                            }
                                            $_1799584481 = $_1642182436;
                                            break;
                        ...
                        $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_240357056, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                    } elseif ($_1639684675['TYPE'] == 'arithmetics') {
                        ...
                        foreach ($_1639684675['ARITHMETICS_FALSE'] as $_1630858607 => $_1528140672) {
                            if ($_1528140672['ARITHMETICS_FALSE_TYPE'] == 'const') {
                                $_385967419 = str_replace('x' . $_1630858607, CDataExportproplusTools::RoundNumber($_1528140672['ARITHMETICS_FALSE_CONTVALUE'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']), $_385967419);
                                    ...
                                    switch (count($_47247544)) {
                                        case 1:
                                            ...
                                            if (strpos($_1528140672['ARITHMETICS_FALSE_VALUE'], '.') !== false) {
                                                ...
                                                unset($_1117656864);
                                                $_1266989984 = CDataExportproplusTools::RoundNumber($_1438955011, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            } else {
                                                $_1266989984 = CDataExportproplusTools::RoundNumber($_1799584481[$_1528140672['ARITHMETICS_FALSE_VALUE']], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                            $_1799584481 = $_1642182436;
                                            break;
                                        case 2:
                                            ...
                                            if (strpos($_47247544[1], '_CURRENCY') > 0) {
                                                ...
                                                $_1266989984 = CDataExportproplusTools::RoundNumber($_1266989984, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                if (is_array($_851873695)) {
                                                ...
                                                if ($this->_1758607422['CURRENCY']['CONVERT_CURRENCY'] == 'Y') {
                                                    if ($this->_1758607422['CURRENCY'][$_1284853936]['CHECK']) {
                                                        $_615351990 = $this->_1758607422['CURRENCY'][$_1284853936]['CONVERT_TO'];
                                                        if ($this->_1758607422['CURRENCY'][$_1284853936]['RATE'] == 'SITE') {
                                                            $_1266989984 = CDataExportproplusTools::RoundNumber(CCurrencyRates::ConvertCurrency($_1799584481['CATALOG_' . $_47247544[1]], $this->_1758607422['CURRENCY'][$_1284853936]['CONVERT_FROM'], $_615351990), $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE'], 0);
                                                            if (is_array($_851873695)) {
                                                                $_480208289 = $_1266989984;
                                                            }
                                                        } else {
                                                            $_1266989984 = CDataExportproplusTools::RoundNumber($_1266989984 * $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_1284853936]['RATE'] / $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_615351990]['RATE'] / $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_1284853936]['RATE_CNT'] * $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_615351990]['RATE_CNT'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE'], 0);
                                                            if (is_array($_851873695)) {
                                                                $_480208289 = $_1266989984;
                                                            }
                                                        }
                                                ...
                                                if ($this->_1758607422['CURRENCY'][$_1284853936]['CHECK']) {
                                                    $_1266989984 += $_1266989984 * floatval($this->_1758607422['CURRENCY'][$_1284853936]['PLUS']) / 100;
                                                    $_1266989984 = CDataExportproplusTools::RoundNumber($_1266989984, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                    if (is_array($_851873695)) {
                                                        $_480208289 = $_1266989984;
                                                    }
                                            ...
                                            if ($_1639684675['BITRIX_ROUND_MODE'] == 'Y') {
                                                $_1266989984 = CDataExportproplusTools::BitrixRoundNumber($_1266989984, $_47247544[1]);
                                            } else {
                                                $_1266989984 = CDataExportproplusTools::RoundNumber($_1266989984, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                            if (is_array($_851873695)) {
                                        ...
                                        case 3:
                                            ...
                                            if (($_47247544[0] == $_1799584481['IBLOCK_ID']) || ($_47247544[0] == $_851873695['IBLOCK_ID'])) {
                                                ...
                                                if (is_array($_212220634)) {
                                                    $_1266989984 = CDataExportproplusTools::RoundNumber($_212220634[0], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                } else {
                                                    $_1266989984 = CDataExportproplusTools::RoundNumber($_212220634, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                }
                                            }
                                            $_1799584481 = $_1642182436;
                                            break;
                                ...
                                $_385967419 = str_replace('x' . $_1630858607, CDataExportproplusTools::RoundNumber($_1266989984, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']), $_385967419);
                                if (!strlen(trim($_1266989984))) {
                                    $this->_940439577->AddMessage("{$_1799584481['NAME']} (ID:{$_1799584481['ID']}) : " . str_replace('#FIELD#', 'x' . $_1630858607, GetMessage('DATA_EXPORTPROPLUS_ARITHMETICS_FIELD_NO_OPERAND')));
                        ...
                        if ($_1175835693) {
                            $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber(CDataExportproplusTools::CalculateString($_385967419), $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                        } else {
                        ...
                        foreach ($_1639684675['STACK_FALSE'] as $_845292619 => $_279295239) {
                            if ($_279295239['STACK_FALSE_TYPE'] == 'const') {
                                $_1880174775 = CDataExportproplusTools::RoundNumber($_279295239['STACK_FALSE_CONTVALUE'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                    ...
                                    switch (count($_47247544)) {
                                        case 1:
                                            ...
                                            if (strpos($_279295239['STACK_FALSE_VALUE'], '.') !== false) {
                                                ...
                                                unset($_1117656864);
                                                $_1880174775 = CDataExportproplusTools::RoundNumber($_1438955011, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            } else {
                                                $_1880174775 = CDataExportproplusTools::RoundNumber($_1799584481[$_279295239['STACK_FALSE_VALUE']], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                            $_1799584481 = $_1642182436;
                                            break;
                                        case 2:
                                            ...
                                            if (strpos($_47247544[1], '_CURRENCY') > 0) {
                                                ...
                                                $_1880174775 = CDataExportproplusTools::RoundNumber($_1880174775, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                if (is_array($_851873695)) {
                                                ...
                                                if ($this->_1758607422['CURRENCY']['CONVERT_CURRENCY'] == 'Y') {
                                                    if ($this->_1758607422['CURRENCY'][$_1284853936]['CHECK']) {
                                                        $_615351990 = $this->_1758607422['CURRENCY'][$_1284853936]['CONVERT_TO'];
                                                        if ($this->_1758607422['CURRENCY'][$_1284853936]['RATE'] == 'SITE') {
                                                            $_1880174775 = CDataExportproplusTools::RoundNumber(CCurrencyRates::ConvertCurrency($_1799584481['CATALOG_' . $_47247544[1]], $this->_1758607422['CURRENCY'][$_1284853936]['CONVERT_FROM'], $_615351990), $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE'], 0);
                                                            if (is_array($_851873695)) {
                                                                $_480208289 = $_1880174775;
                                                            }
                                                        } else {
                                                            $_1880174775 = CDataExportproplusTools::RoundNumber($_1880174775 * $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_1284853936]['RATE'] / $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_615351990]['RATE'] / $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_1284853936]['RATE_CNT'] * $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_615351990]['RATE_CNT'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE'], 0);
                                                            if (is_array($_851873695)) {
                                                                $_480208289 = $_1880174775;
                                                            }
                                                        }
                                                ...
                                                if ($this->_1758607422['CURRENCY'][$_1284853936]['CHECK']) {
                                                    $_1880174775 += $_1880174775 * floatval($this->_1758607422['CURRENCY'][$_1284853936]['PLUS']) / 100;
                                                    $_1880174775 = CDataExportproplusTools::RoundNumber($_1880174775, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                    if (is_array($_851873695)) {
                                                        $_480208289 = $_1880174775;
                                                    }
                                            ...
                                            if ($_1639684675['BITRIX_ROUND_MODE'] == 'Y') {
                                                $_1880174775 = CDataExportproplusTools::BitrixRoundNumber($_1880174775, $_47247544[1]);
                                            } else {
                                                $_1880174775 = CDataExportproplusTools::RoundNumber($_1880174775, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                            if (is_array($_851873695)) {
                                        ...
                                        case 3:
                                            ...
                                            if (($_47247544[0] == $_1799584481['IBLOCK_ID']) || ($_47247544[0] == $_851873695['IBLOCK_ID'])) {
                                                ...
                                                if (is_array($_212220634)) {
                                                    ...
                                                    foreach ($_212220634 as $_32014025) {
                                                        if (intval($this->_1758607422['XMLDATA'][$_1639684675['CODE']]['MULTIPROP_LIMIT']) > 0) {
                                                            if (count($_1880174775) < $this->_1758607422['XMLDATA'][$_1639684675['CODE']]['MULTIPROP_LIMIT']) {
                                                                $_1880174775[] = CDataExportproplusTools::RoundNumber($_32014025, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                            }
                                                        } else {
                                                            $_1880174775[] = CDataExportproplusTools::RoundNumber($_32014025, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                        }
                                                    ...
                                                    $_1880174775 = CDataExportproplusTools::RoundNumber($_212220634, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                }
                                            }
                                            $_1799584481 = $_1642182436;
                                            break;
                            ...
                            if ((is_array($_1880174775) && !empty($_1880174775)) || (strlen(trim($_1880174775)) > 0)) {
                                $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_1880174775, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                break;
                            }
                        }
                    } else {
                        ...
                        if (($_1639684675['CODE'] == 'URL') && function_exists('detailLink')) {
                            ...
                            if (function_exists('dataRedefine')) {
                                $_1766828534[$_1295533077] = dataRedefine($_1295533077, $_1799584481['ID'], $this->_1758607422['ID']);
                            }
                                ...
                                switch (count($_47247544)) {
                                    case 1:
                                        ...
                                        if (strpos($_1639684675['VALUE'], '.') !== false) {
                                            ...
                                            unset($_1117656864);
                                            $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_1438955011, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                        } else {
                                            $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_1799584481[$_1639684675['VALUE']], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                        }
                                        $_1799584481 = $_1642182436;
                                        break;
                                    case 2:
                                        ...
                                        if (strpos($_47247544[1], '_CURRENCY') > 0) {
                                            ...
                                            $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_1766828534[$_1295533077], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            if (is_array($_851873695)) {
                                            ...
                                            if ($this->_1758607422['CURRENCY']['CONVERT_CURRENCY'] == 'Y') {
                                                if ($this->_1758607422['CURRENCY'][$_1284853936]['CHECK']) {
                                                    $_615351990 = $this->_1758607422['CURRENCY'][$_1284853936]['CONVERT_TO'];
                                                    if ($this->_1758607422['CURRENCY'][$_1284853936]['RATE'] == 'SITE') {
                                                        $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber(CCurrencyRates::ConvertCurrency($_1799584481['CATALOG_' . $_47247544[1]], $this->_1758607422['CURRENCY'][$_1284853936]['CONVERT_FROM'], $_615351990), $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE'], 0);
                                                        if (is_array($_851873695)) {
                                                            $_480208289 = $_1766828534[$_1295533077];
                                                        }
                                                    } else {
                                                        $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_1766828534[$_1295533077] * $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_1284853936]['RATE'] / $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_615351990]['RATE'] / $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_1284853936]['RATE_CNT'] * $this->_2112071826[$this->_1758607422['CURRENCY'][$_1284853936]['RATE']][$_615351990]['RATE_CNT'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE'], 0);
                                                        if (is_array($_851873695)) {
                                                            $_480208289 = $_1766828534[$_1295533077];
                                                        }
                                                    }
                                            ...
                                            if ($this->_1758607422['CURRENCY'][$_1284853936]['CHECK']) {
                                                $_1766828534[$_1295533077] += $_1766828534[$_1295533077] * floatval($this->_1758607422['CURRENCY'][$_1284853936]['PLUS']) / 100;
                                                $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_1766828534[$_1295533077], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                if (is_array($_851873695)) {
                                                    $_480208289 = $_1766828534[$_1295533077];
                                                }
                                        ...
                                        if ($_1639684675['BITRIX_ROUND_MODE'] == 'Y') {
                                            $_1766828534[$_1295533077] = CDataExportproplusTools::BitrixRoundNumber($_1766828534[$_1295533077], $_47247544[1]);
                                        } else {
                                            $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_1766828534[$_1295533077], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                        }
                                        if (is_array($_851873695)) {
                                    ...
                                    case 3:
                                        ...
                                        if ($_47247544[0] == $_1799584481['IBLOCK_ID'] || $_47247544[0] == $_851873695['IBLOCK_ID']) {
                                            ...
                                            if (is_array($_212220634)) {
                                                ...
                                                foreach ($_212220634 as $_32014025) {
                                                    if (intval($this->_1758607422['XMLDATA'][$_1639684675['CODE']]['MULTIPROP_LIMIT']) > 0) {
                                                        if (count($_1766828534[$_1295533077]) < $this->_1758607422['XMLDATA'][$_1639684675['CODE']]['MULTIPROP_LIMIT']) {
                                                            $_1766828534[$_1295533077][] = CDataExportproplusTools::RoundNumber($_32014025, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                        }
                                                    } else {
                                                        $_1766828534[$_1295533077][] = CDataExportproplusTools::RoundNumber($_32014025, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                                    }
                                                ...
                                                $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_212220634, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                        }
                                        $_1799584481 = $_1642182436;
                                        break;
                ...
                if (($_1639684675['TYPE'] == 'field') || ($_1639684675['TYPE'] == 'composite') || ($_1639684675['TYPE'] == 'arithmetics') || ($_1639684675['TYPE'] == 'stack') || (($_1639684675['TYPE'] == 'complex') && ($_1639684675['COMPLEX_TRUE_TYPE'] == 'field'))) {
                    if ($_1639684675['TYPE'] == 'composite') {
                        ...
                        foreach ($_1639684675['COMPOSITE_TRUE'] as $_628180431 => $_111434879) {
                            ...
                            if ($_111434879['COMPOSITE_TRUE_TYPE'] == 'const') {
                                $_240357056 .= CDataExportproplusTools::RoundNumber($_111434879['COMPOSITE_TRUE_CONTVALUE'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                    ...
                                    switch (count($_47247544)) {
                                        case 1:
                                            ...
                                            if (strpos($_111434879['COMPOSITE_TRUE_VALUE'], '.') !== false) {
                                                ...
                                                $_647344568 = CDataExportproplusTools::RoundNumber($_1799584481[$_111434879['COMPOSITE_TRUE_VALUE']], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                            $_1799584481 = $_1642182436;
                                            break;
                                        case 2:
                        ...
                        foreach ($_1639684675['ARITHMETICS_TRUE'] as $_1630858607 => $_1528140672) {
                            if ($_1528140672['ARITHMETICS_TRUE_TYPE'] == 'const') {
                                $_1461018321 = str_replace('x' . $_1630858607, CDataExportproplusTools::RoundNumber($_1528140672['ARITHMETICS_TRUE_CONTVALUE'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']), $_1461018321);
                                    ...
                                    switch (count($_47247544)) {
                                        case 1:
                                            ...
                                            if (strpos($_1528140672['ARITHMETICS_TRUE_VALUE'], '.') !== false) {
                                                ...
                                                $_1266989984 = CDataExportproplusTools::RoundNumber($_1799584481[$_1528140672['ARITHMETICS_TRUE_VALUE']], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                            $_1799584481 = $_1642182436;
                                            break;
                                        case 2:
                                ...
                                $_1461018321 = str_replace('x' . $_1630858607, CDataExportproplusTools::RoundNumber($_1266989984, $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']), $_1461018321);
                                if (!strlen(trim($_1266989984))) {
                                    $this->_940439577->AddMessage("{$_1799584481['NAME']} (ID:{$_1799584481['ID']}) : " . str_replace('#FIELD#', 'x' . $_1630858607, GetMessage('DATA_EXPORTPROPLUS_ARITHMETICS_FIELD_NO_OPERAND')));
                                    $this->_940439577->IncProductError();
                                    $_685823106 = false;
                        ...
                        if ($_685823106) {
                            $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber(CDataExportproplusTools::CalculateString($_1461018321), $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                        } else {
                            $_1766828534[$_1295533077] = '';
                        }
                    } elseif ($_1639684675['TYPE'] == 'stack') {
                        ...
                        foreach ($_1639684675['STACK_TRUE'] as $_845292619 => $_279295239) {
                            if ($_279295239['STACK_TRUE_TYPE'] == 'const') {
                                $_1880174775 = CDataExportproplusTools::RoundNumber($_279295239['STACK_TRUE_CONTVALUE'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                    ...
                                    switch (count($_47247544)) {
                                        case 1:
                                            ...
                                            if (strpos($_279295239['STACK_TRUE_VALUE'], '.') !== false) {
                                                ...
                                                $_1880174775 = CDataExportproplusTools::RoundNumber($_1799584481[$_279295239['STACK_TRUE_VALUE']], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                                            }
                                            $_1799584481 = $_1642182436;
                                            break;
                                        case 2:
                    ...
                    $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber($_1639684675['CONTVALUE_TRUE'], $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                } else {
                    $_1766828534[$_1295533077] = '';
                }
            }
            if ($_1639684675['EXPORT_ROWCATEGORY_PARENT_LIST'] == 'Y') {
                ...
                if ($DB->IsDate($_1766828534[$_1295533077]) && ($this->_1758607422['DATEFORMAT'] == $this->_317570903)) {
                    $_1766828534[$_1295533077] = CDataExportproplusTools::RoundNumber(CDataExportproplusTools::GetYandexDateTime($_1766828534[$_1295533077]), $_1639684675['ROUND']['PRECISION'], $_1639684675['ROUND']['MODE']);
                    $_206406255 = MakeTimeStamp('');
                    $_1161211064 = date('Y-m-d', $_206406255);
                    if (stripos($_1766828534[$_1295533077], $_1161211064) !== false) {
                        $_1304010677 = true;
                        $this->_940439577->AddMessage("{$_1799584481['NAME']} (ID:{$_1799584481['ID']}) : " . str_replace('#FIELD#', $_1295533077, GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_SKIP')));
                        $this->_940439577->IncProductError();
                    }
                }
                if ($_409953385) {
                    $_1766828534 = CDataExportproplusStringProcess::ProcessTagOptions($_1766828534, $_1639684675, $_1295533077);
                } else {
                    $_1766828534 = CDataExportproplusStringProcess::ProcessTagOptions($_1766828534, $_1639684675, $_1295533077, true, $_1108326879, $this->_547888680);
                }
            }
        ...
        if (!$_409953385) {
            ...
            if (function_exists('dataRedefine')) {
                $_1767388196 = dataRedefine($_548088880 . 'MARKET_CATEGORY' . $_548088880, $_1799584481['ID'], $this->_1758607422['ID']);
                if ($_1767388196) {
            ...
            if (!$_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880]) {
                switch ($this->_1758607422['TYPE']) {
                    case 'ebay':
                    case 'ebay_1':
                    case 'ebay_2':
                        if ($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') {
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['EBAY']['CATEGORY_LIST'][$_1799584481['IBLOCK_ID']];
                        } elseif ($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') {
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['EBAY']['CATEGORY_LIST'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']];
                        } else {
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['EBAY']['CATEGORY_LIST'][$_1799584481['IBLOCK_SECTION_ID']];
                        }
                        $_1759525527 = $this->_1758607422['MARKET_CATEGORY']['EBAY']['CATEGORY_LIST'];
                        break;
                    case 'google':
                    case 'google_online':
                        if (($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') && ($this->_1758607422['USE_MARKET_CATEGORY'] == 'Y')) {
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_ID']];
                        } elseif (($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') && ($this->_1758607422['USE_MARKET_CATEGORY'] == 'Y')) {
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']];
                        } else {
                            if ($this->_1758607422['USE_MARKET_CATEGORY'] == 'Y') {
                                $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_SECTION_ID']];
                            }
                        }
                        $_1759525527 = $this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'];
                        break;
                    case 'ozon':
                    case 'ozon_api':
                        if ($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') {
                            if (strlen(trim($this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'][$_1799584481['IBLOCK_ID']])) <= 0) {
                                return $_1799584481;
                            }
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'][$_1799584481['IBLOCK_ID']];
                            if (!empty($_1768420642)) {
                                foreach ($_1768420642 as $_1474817292) {
                                    if ($_1474817292['ProductTypeId'] == $this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'][$_1799584481['IBLOCK_ID']]) {
                                        $_1766828534[$_548088880 . 'CAPABILITY_TYPE' . $_548088880] = $_1474817292['Name'];
                                    }
                                }
                            }
                        } elseif ($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') {
                            if (strlen(trim($this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']])) <= 0) {
                                return $_1799584481;
                            }
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']];
                            if (!empty($_1768420642)) {
                                foreach ($_1768420642 as $_1474817292) {
                                    if ($_1474817292['ProductTypeId'] == $this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']]) {
                                        $_1766828534[$_548088880 . 'CAPABILITY_TYPE' . $_548088880] = $_1474817292['Name'];
                                    }
                                }
                            }
                        } else {
                            if (strlen(trim($this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'][$_1799584481['IBLOCK_SECTION_ID']])) <= 0) {
                                return $_1799584481;
                            }
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'][$_1799584481['IBLOCK_SECTION_ID']];
                            if (!empty($_1768420642)) {
                                foreach ($_1768420642 as $_1474817292) {
                                    if ($_1474817292['ProductTypeId'] == $this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'][$_1799584481['IBLOCK_SECTION_ID']]) {
                                        $_1766828534[$_548088880 . 'CAPABILITY_TYPE' . $_548088880] = $_1474817292['Name'];
                                    }
                                }
                            }
                        }
                        $_1759525527 = $this->_1758607422['MARKET_CATEGORY']['OZON']['CATEGORY_LIST'];
                        break;
                    case 'vk_trade':
                        if (!$_409953385) {
                            if ($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') {
                                $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['VK']['CATEGORY_LIST'][$_1799584481['IBLOCK_ID']];
                            } elseif ($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') {
                                $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['VK']['CATEGORY_LIST'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']];
                            } else {
                                $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = $this->_1758607422['MARKET_CATEGORY']['VK']['CATEGORY_LIST'][$_1799584481['IBLOCK_SECTION_ID']];
                            }
                            $_1759525527 = $this->_1758607422['MARKET_CATEGORY']['VK']['CATEGORY_LIST'];
                            break;
                        }
                    case 'y_realty':
                        break;
                        ...
                        if ($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') {
                            ...
                            if (!empty($this->_1615441130) && !empty($_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880])) {
                                foreach ($this->_1615441130 as $_506626893) {
                                    if ($_506626893['NAME'] == $this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_ID']]) {
                            ...
                            if (!empty($this->_1615441130) && !empty($_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880])) {
                                foreach ($this->_1615441130 as $_506626893) {
                                    if ($_506626893['NAME'] == $this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']]) {
                                        $_1766828534[$_548088880 . 'PORTAL_ID' . $_548088880] = $_506626893['PORTAL_ID'];
                                        $_1766828534[$_548088880 . 'PORTAL_URL' . $_548088880] = $_506626893['PORTAL_URL'];
                                        break;
                                    }
                            ...
                            if (!empty($this->_1615441130) && !empty($_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880])) {
                                foreach ($this->_1615441130 as $_506626893) {
                                    if ($_506626893['NAME'] == $this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_SECTION_ID']]) {
                                        $_1766828534[$_548088880 . 'PORTAL_ID' . $_548088880] = $_506626893['PORTAL_ID'];
                                        $_1766828534[$_548088880 . 'PORTAL_URL' . $_548088880] = $_506626893['PORTAL_URL'];
                                        break;
                                    }
                    ...
                    default:
                        $_171110304 = false;
                        if (($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') && ($this->_1758607422['USE_MARKET_CATEGORY'] == 'Y')) {
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = htmlspecialcharsbx($this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_ID']]);
                            $_171110304 = true;
                        } elseif (($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') && ($this->_1758607422['USE_MARKET_CATEGORY'] == 'Y')) {
                            $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = htmlspecialcharsbx($this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']]);
                            $_171110304 = true;
                        } else {
                            if ($this->_1758607422['USE_MARKET_CATEGORY'] == 'Y') {
                                if (is_array($_1799584481['SECTION_ID']) && !empty($_1799584481['SECTION_ID'])) {
                                    $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = '';
                                    foreach ($_1799584481['SECTION_ID'] as $_401081284) {
                                        $_792912379 = htmlspecialcharsbx(trim($this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_401081284]));
                                    ...
                                    if ($_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] == '') {
                                        $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = htmlspecialcharsbx($this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_SECTION_ID']]);
                                    }
                                } else {
                                    $_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880] = htmlspecialcharsbx($this->_1758607422['MARKET_CATEGORY']['CATEGORY_LIST'][$_1799584481['IBLOCK_SECTION_ID']]);
                                }
            ...
            if ($this->_1758607422['SETUP']['USE_CATEGORY_REDEFINE_TAG'] == 'Y') {
                if (strlen(trim($this->_1758607422['SETUP']['CATEGORY_REDEFINE_TAG'])) > 0) {
                    $_1366184680 = $_1759525527[$_1766828534[$_548088880 . $this->_1758607422['SETUP']['CATEGORY_REDEFINE_TAG'] . $_548088880]];
                    $_1207475988 = $this->_1758607422['PROFILE_CATEGORIES'][$_1766828534[$_548088880 . $this->_1758607422['SETUP']['CATEGORY_REDEFINE_TAG'] . $_548088880]]['NAME'];
                    if (strlen(trim($_1366184680)) > 0) {
                        $_1766828534[$_548088880 . $this->_1758607422['SETUP']['CATEGORY_REDEFINE_TAG'] . $_548088880] = trim($_1366184680);
                    } elseif (strlen(trim($_1207475988)) > 0) {
                        $_1766828534[$_548088880 . $this->_1758607422['SETUP']['CATEGORY_REDEFINE_TAG'] . $_548088880] = trim($_1207475988);
                    }
                }
            }
            ...
            switch ($this->_1758607422['TYPE']) {
                case 'vk_trade':
                    if ($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') {
                        $_1766828534[$_548088880 . 'VK_MARKET_ALBUMS' . $_548088880] = $this->_1758607422['VK']['VK_MARKET_ALBUMS'][$_1799584481['IBLOCK_ID']];
                    } elseif ($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') {
                        $_1766828534[$_548088880 . 'VK_MARKET_ALBUMS' . $_548088880] = $this->_1758607422['VK']['VK_MARKET_ALBUMS'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']];
                    } elseif ($this->_1758607422['VK']['VK_IS_MARKET_ALBUMS_MULTICATEGORIES'] == 'Y') {
                        $_1766828534[$_548088880 . 'VK_MARKET_ALBUMS' . $_548088880] = array();
                        foreach ($_1799584481['SECTION_EXDATA'] as $_1496645552 => $_994241955) {
                            $_1766828534[$_548088880 . 'VK_MARKET_ALBUMS' . $_548088880][$_1496645552] = array('ID' => $_1799584481['IBLOCK_SECTION_ID'], 'NAME' => $this->_1758607422['VK']['VK_MARKET_ALBUMS'][$_1496645552], 'PICTURE' => (intval($_994241955['PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955['PICTURE'])) : false, 'DETAIL_PICTURE' => (intval($_994241955['DETAIL_PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955['DETAIL_PICTURE'])) : false);
                        }
                    } else {
                        $_1766828534[$_548088880 . 'VK_MARKET_ALBUMS' . $_548088880] = array();
                        $_1766828534[$_548088880 . 'VK_MARKET_ALBUMS' . $_548088880][] = array('ID' => $_1799584481['IBLOCK_SECTION_ID'], 'NAME' => $this->_1758607422['VK']['VK_MARKET_ALBUMS'][$_1799584481['IBLOCK_SECTION_ID']], 'PICTURE' => (intval($_994241955[0]['PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955[0]['PICTURE'])) : false, 'DETAIL_PICTURE' => (intval($_994241955[0]['DETAIL_PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955[0]['DETAIL_PICTURE'])) : false);
                    }
                    break;
                default:
                    break;
            ...
            switch ($this->_1758607422['TYPE']) {
                case 'vk_trade':
                    if ($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') {
                        $_1766828534[$_548088880 . 'VK_ALBUMS' . $_548088880] = $this->_1758607422['VK']['VK_ALBUMS'][$_1799584481['IBLOCK_ID']];
                    } elseif ($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') {
                        $_1766828534[$_548088880 . 'VK_ALBUMS' . $_548088880] = $this->_1758607422['VK']['VK_ALBUMS'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']];
                    } elseif ($this->_1758607422['VK']['VK_IS_ALBUMS_MULTICATEGORIES'] == 'Y') {
                        $_1766828534[$_548088880 . 'VK_ALBUMS' . $_548088880] = array();
                        foreach ($_1799584481['SECTION_EXDATA'] as $_1496645552 => $_994241955) {
                            $_1766828534[$_548088880 . 'VK_ALBUMS' . $_548088880][$_1496645552] = array('ID' => $_1799584481['IBLOCK_SECTION_ID'], 'NAME' => $this->_1758607422['VK']['VK_ALBUMS'][$_1496645552], 'PICTURE' => (intval($_994241955['PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955['PICTURE'])) : false, 'DETAIL_PICTURE' => (intval($_994241955['DETAIL_PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955['DETAIL_PICTURE'])) : false);
                        }
                    } else {
                        $_1766828534[$_548088880 . 'VK_ALBUMS' . $_548088880] = array();
                        $_1766828534[$_548088880 . 'VK_ALBUMS' . $_548088880][] = array('ID' => $_1799584481['IBLOCK_SECTION_ID'], 'NAME' => $this->_1758607422['VK']['VK_ALBUMS'][$_1799584481['IBLOCK_SECTION_ID']], 'PICTURE' => (intval($_994241955[0]['PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955[0]['PICTURE'])) : false, 'DETAIL_PICTURE' => (intval($_994241955[0]['DETAIL_PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955[0]['DETAIL_PICTURE'])) : false);
                    }
                    break;
                default:
                    break;
            ...
            switch ($this->_1758607422['TYPE']) {
                case 'ok_trade':
                    if ($this->_1758607422['USE_IBLOCK_CATEGORY'] == 'Y') {
                        $_1766828534[$_548088880 . 'OK_ALBUMS' . $_548088880] = $this->_1758607422['OK']['OK_ALBUMS'][$_1799584481['IBLOCK_ID']];
                    } elseif ($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') {
                        $_1766828534[$_548088880 . 'OK_ALBUMS' . $_548088880] = $this->_1758607422['OK']['OK_ALBUMS'][$_1799584481['IBLOCK_PRODUCT_SECTION_ID']];
                    } elseif ($this->_1758607422['OK']['OK_IS_ALBUMS_MULTICATEGORIES'] == 'Y') {
                        $_1766828534[$_548088880 . 'OK_ALBUMS' . $_548088880] = array();
                        foreach ($_1799584481['SECTION_EXDATA'] as $_1496645552 => $_994241955) {
                            $_1766828534[$_548088880 . 'OK_ALBUMS' . $_548088880][$_1496645552] = array('ID' => $_1799584481['IBLOCK_SECTION_ID'], 'NAME' => $this->_1758607422['OK']['OK_ALBUMS'][$_1496645552], 'PICTURE' => (intval($_994241955['PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955['PICTURE'])) : false, 'DETAIL_PICTURE' => (intval($_994241955['DETAIL_PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955['DETAIL_PICTURE'])) : false);
                        }
                    } else {
                        $_1766828534[$_548088880 . 'OK_ALBUMS' . $_548088880][] = array('ID' => $_1799584481['IBLOCK_SECTION_ID'], 'NAME' => $this->_1758607422['OK']['OK_ALBUMS'][$_1799584481['IBLOCK_SECTION_ID']], 'PICTURE' => (intval($_994241955[0]['PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955[0]['PICTURE'])) : false, 'DETAIL_PICTURE' => (intval($_994241955[0]['DETAIL_PICTURE']) > 0) ? array($_SERVER['DOCUMENT_ROOT'] . CFile::GetPath($_994241955[0]['DETAIL_PICTURE'])) : false);
                    }
                    break;
                default:
                    break;
            ...
            if ($this->_1758607422['TYPE'] == 'vk_trade') {
                if ((strlen($_1766828534[$_548088880 . 'NAME' . $_548088880]) > 0) && (intval($_1766828534[$_548088880 . 'PRICE' . $_548088880]) > 0) && (strlen($_1766828534[$_548088880 . 'URL' . $_548088880]) > 0) && (strlen($_1766828534[$_548088880 . 'PHOTO' . $_548088880]) > 0) && (intval($_1766828534[$_548088880 . 'MARKET_CATEGORY' . $_548088880]) > 0)) {
                    ...
                    $_421487420['DESCRIPTION_PREFIX'] = GetMessage('DATA_FB_PRICE') . $_1766828534[$_548088880 . 'PRICE' . $_548088880] . ' ' . GetMessage('DATA_FB_PRICE_CURRENCY') . '
...
';
            ...
            } elseif ($this->_1758607422['TYPE'] == 'fb_trade') {
                if ((strlen($_1766828534[$_548088880 . 'NAME' . $_548088880]) > 0) && (intval($_1766828534[$_548088880 . 'PRICE' . $_548088880]) > 0) && (strlen($_1766828534[$_548088880 . 'URL' . $_548088880]) > 0) && (strlen($_1766828534[$_548088880 . 'PHOTO' . $_548088880]) > 0)) {
                    ...
                    $_421487420['ID'] = $_1766828534[$_548088880 . 'ID' . $_548088880];
                    $_421487420['NAME'] = $_1766828534[$_548088880 . 'NAME' . $_548088880];
                    $_421487420['URL'] = $this->_1758607422['SITE_PROTOCOL'] . '://' . $this->_1758607422['DOMAIN_NAME'] . $_1766828534[$_548088880 . 'URL' . $_548088880];
                    $_421487420['MESSAGE'] = GetMessage('DATA_FB_PRICE') . $_1766828534[$_548088880 . 'PRICE' . $_548088880] . ' ' . $_1766828534[$_548088880 . 'CURRENCYID' . $_548088880] . '
...
' . $_1766828534[$_548088880 . 'MESSAGE' . $_548088880];
                    ...
                    if (is_array($_1766828534[$_548088880 . 'PHOTO' . $_548088880]) && !empty($_1766828534[$_548088880 . 'PHOTO' . $_548088880])) {
                        $_421487420['PHOTO'] = $this->_1758607422['SITE_PROTOCOL'] . '://' . $this->_1758607422['DOMAIN_NAME'] . $_1766828534[$_548088880 . 'PHOTO' . $_548088880][0];
                    } else {
                        $_421487420['PHOTO'] = $this->_1758607422['SITE_PROTOCOL'] . '://' . $this->_1758607422['DOMAIN_NAME'] . $_1766828534[$_548088880 . 'PHOTO' . $_548088880];
                    }
                    $this->_116831045->ProcessData($_421487420);
                    $this->DemoCountInc();
                }
            } elseif ($this->_1758607422['TYPE'] == 'instagram_trade') {
...
' . GetMessage('DATA_FB_PRICE') . $_1766828534[$_548088880 . 'PRICE' . $_548088880] . ' ' . $_1766828534[$_548088880 . 'CURRENCYID' . $_548088880] . '
...
' . $_1766828534[$_548088880 . 'MESSAGE' . $_548088880];
            ...
            } elseif ($this->_1758607422['TYPE'] == 'ok_trade') {
                if ((strlen($_1766828534[$_548088880 . 'NAME' . $_548088880]) > 0) && (intval($_1766828534[$_548088880 . 'PRICE' . $_548088880]) > 0) && (strlen($_1766828534[$_548088880 . 'URL' . $_548088880]) > 0) && (strlen($_1766828534[$_548088880 . 'PHOTO' . $_548088880]) > 0)) {
                    $_421487420 = array();
                    $_421487420['ID'] = $_1766828534[$_548088880 . 'ID' . $_548088880];
                    $_421487420['NAME'] = $_1766828534[$_548088880 . 'NAME' . $_548088880];
                    ...
                    $_421487420['URL'] = $this->_1758607422['SITE_PROTOCOL'] . '://' . $this->_1758607422['DOMAIN_NAME'] . $_1766828534[$_548088880 . 'URL' . $_548088880] . ((strlen($_1996143159) > 0) ? $_1996143159 : '');
                    $_421487420['DESCRIPTION'] = GetMessage('DATA_OK_PRICE') . $_1766828534[$_548088880 . 'PRICE' . $_548088880] . ' ' . $_1766828534[$_548088880 . 'CURRENCYID' . $_548088880] . '
...
', $_1108326879);
                ...
                if ($this->_1758607422['USE_EMPTY_TAG_CUT'] == 'Y') {
                ...
                if ($this->_1758607422['SETUP']['CONVERT_DATA_REGEXP'] == 'Y') {
                    if (!empty($this->_1758607422['CONVERT_DATA'])) {
                        foreach ($this->_1758607422['CONVERT_DATA'] as $_1304710919) {
                ...
                if (!$_1304010677) {
                    if ($this->_1758607422['TYPE'] == 'ozon_api') {
                        ...
                        if (!isset($this->_1758607422['SETUP']['OZON_JOBS'])) {
                            $this->_1758607422['SETUP']['OZON_JOBS'] = array();
                            $this->_1758607422['SETUP']['OZON_DATA'] = array();
                        }
                        $this->_1758607422['SETUP']['OZON_JOBS'][] = $_1372257598['JobId'];
                        $this->_1758607422['SETUP']['OZON_DATA'][$_1766828534[$_548088880 . 'ID' . $_548088880]] = $_1717737781;
                        $this->_1232139345->Update($this->_1758607422['ID'], $this->_1758607422);
                    } else {
                        ...
                        CDataExportproplusTools::SaveSections($this->_1758607422, $_1250329899);
                        $this->DemoCountInc();
                        if (!CDataExportproplusTools::isVariant($this->_1758607422, $_982944057)) {
                            if (isset($_1030859019['DELAY_FLUSH']) && ($_1030859019['DELAY_FLUSH'] === true)) {
                                CDataExportproplusExport::Save($_1108326879 . $this->_86593573);
                                $this->_86593573 = '';
                                ...
                                CDataExportproplusExport::Save($_1108326879);
                                $this->_940439577->IncProductExport();
                            }
                        }
                    }
                ...
                if (CDataExportproplusTools::isVariant($this->_1758607422, $_982944057)) return array('ITEM' => $_1799584481, 'XML' => $_1108326879, 'SKIP' => $_1304010677, 'OFFER' => is_array($_851873695));
            }
            return $_1799584481;
        } else {
            if (!$_1304010677) {
    ...
    private function __502044406($_485935950, $_851873695 = false)
    {
        ...
        if (!$_851873695 && ($this->_1758607422['EXPORT_DATA_OFFER_WITH_SKU_DATA'] != 'Y')) {
            if ($_1799584481['_OFFERS_COUNT'] > 0) {
                return $_1799584481;
            }
        }
        if (($this->_1758607422['EXPORT_DATA_OFFER_WITH_SKU_DATA'] == 'Y') && !$_851873695 && $this->_2078735835[$_1799584481['IBLOCK_ID']]['OFFERS_IBLOCK_ID']) {
            ...
            if ($this->_1758607422['SETUP']['OFFER_WITH_SKU_USE_QUANTITY'] == 'Y') {
        ...
        if ($this->_1768427482 && is_array($_851873695)) {
            ...
            if ($this->_1758607422['SETUP']['SKU_USE_CANONICAL'] == 'Y' && trim($_851873695['CANONICAL_PAGE_URL']) != '') {
            ...
            foreach ($this->_1758607422['NAMESCHEMA'] as $_1208095729 => $_1438955011) {
                switch ($_1438955011) {
    ...
    private function __1641660486($_485935950)
    {
        ...
        foreach ($_1799584481 as $_1208095729 => &$_1438955011) {
            if (in_array($_1208095729, $this->_15755796)) {
                $_1438955011 = date(str_replace('_', ' ', $this->_1758607422['DATEFORMAT']), strtotime($_1438955011));
            }
        }
        if ($this->_1758607422['USE_IBLOCK_PRODUCT_CATEGORY'] == 'Y') {
            ...
            $_1027951075 = CDataExportproplusTools::GetProperties($_1799584481, array('ID' => $_119952027));
        ...
        if (is_array($_1799584481['SECTION_ID']) && !empty($_1799584481['SECTION_ID']) && is_array($this->_1758607422['CATEGORY']) && !empty($this->_1758607422['CATEGORY'])) {
            ...
            foreach ($_1715674806 as $_2085552139 => $_340672755) {
                ...
                while ($_419516118 = $_1175723977->GetNext()) {
                    if (in_array($_419516118['ID'], $this->_1758607422['CATEGORY'])) {
                        $_945247598 = true;
                        break;
                    }
                }
        ...
        $_1290390566 = CDataExportproplusTools::GetIblockUserFields($_1799584481['IBLOCK_ID']);
        ...
        if (count($this->_845490442['ID'])) {
            $_838141040 = CDataExportproplusTools::GetProperties($_1799584481, array('ID' => $this->_845490442['ID']));
            ...
            foreach ($_838141040 as $_2037385115) {
                if ($_2037385115['USER_TYPE'] == 'DateTime') {
                    $_2037385115['DISPLAY_VALUE'] = date(str_replace('_', ' ', $this->_1758607422['DATEFORMAT']), strtotime($_2037385115['VALUE']));
                    ...
                    $_2037385115 = CIBlockFormatProperties::GetDisplayValue($_1799584481, $_2037385115, 'data_exportproplus_event');
        ...
        if ($this->_1768427482) {
            ...
            while ($_1168058661 = $_2112464209->Fetch()) {
                ...
                if (in_array('PRICE_' . $_1168058661['CATALOG_GROUP_ID'] . '_WD', $this->_1931809273) || in_array('PRICE_' . $_1168058661['CATALOG_GROUP_ID'] . '_D', $this->_1931809273)) {
                    $_1432753308 = CCatalogDiscount::GetDiscountByPrice($_1168058661['ID'], $USER->GetUserGroupArray(), 'N', $this->_1758607422['LID']);
            ...
            if (!isset($_1799584481["CATALOG_PRICE_{$this->_1294848254}"]) && ($this->_1758607422['USE_AUTOPRICE'] == 'Y')) {
                if ($_2056743916 = CCatalogProduct::GetOptimalPrice($_1799584481['ID'], 1, array(2), 'N', array(), $this->_1758607422['LID'], array())) {
    ...
    {
        $_243855875 = DataExportproplusSession::GetSession($this->_1758607422["ID"]);
        if (!isset($_243855875['EXPORTPROPLUS'][$this->_1758607422['ID']]['DEMO_COUNT'])) $_243855875['EXPORTPROPLUS'][$this->_1758607422['ID']]['DEMO_COUNT'] = 0;
        $_243855875['EXPORTPROPLUS'][$this->_1758607422['ID']]['DEMO_COUNT']++;
        DataExportproplusSession::SetSession($this->_1758607422['ID'], $_243855875);
    }
    ...
    public function ProcessCSV($_1634919591 = 1, $_1022528073 = false, $_2060967116 = false, $_1683462550 = false, $_3267963 = false)
    {
        ...
        if (!is_object($_1461419195)) return false;
        $_239173557 = (intval($_1461419195->_1235249829) > 0) ? $_1461419195->_1235249829 : ceil($_1461419195->SelectedRowsCount() / $this->_1418013741);
        $_243855875 = DataExportproplusSession::GetSession($this->_1758607422['ID']);
        $_243855875['EXPORTPROPLUS']['LOG'][$this->_1758607422['ID']]['STEPS'] = $this->_1480025059 ? 1 : $_239173557;
        DataExportproplusSession::SetSession($this->_1758607422['ID'], $_243855875);
        if ($this->_1758607422['TYPE'] == 'advantshop') {
            self::ProcessBasicCsv($_1461419195, $_2060967116, $_1634919591, $_239173557, $_3267963);
        } else {
            self::ProcessBasicCsv($_1461419195, $_2060967116, $_1634919591, $_239173557, $_3267963);
        }
        if (!$_1022528073) {
            echo '<div id="csv_process" style="width: 100%; text-align: center; font-size: 18px; margin: 40px 0; padding: 40px 0; border: 1px solid #ccc; border-radius: 6px; background: #f5f5f5;">', GetMessage('DATA_EXPORTPROPLUS_RUN_EXPORT_RUN'), '<br/>', str_replace(array('#PROFILE_ID#', '#PROFILE_NAME#'), array($this->_1758607422['ID'], $this->_1758607422['NAME']), GetMessage('DATA_EXPORTPROPLUS_RUN_STEP_PROFILE')), '<br/>', str_replace(array('#STEP#', '#COUNT#'), array($_1634919591, $_239173557), GetMessage('DATA_EXPORTPROPLUS_RUN_STEP_RUN')), '</div>';
        }
    ...
    public function ProcessBasicCsv($_1461419195, $_2060967116, $_1634919591, $_239173557, $_3267963 = false)
    {
        ...
        $_277873286 = false;
        $_559483616 = false;
        if (($this->_1758607422['EXPORT_DATA_OFFER'] == 'Y')) {
            $_1813127374 = true;
        }
        if ($this->_1758607422['EXPORT_DATA_OFFER_WITH_SKU_DATA'] == 'Y') {
            $_1304313284 = true;
        }
        if ($this->_1758607422['EXPORT_DATA_SKU'] == 'Y') {
            $_277873286 = true;
        }
        if ($this->_1758607422['EXPORT_DATA_SKU_BY_OFFER'] == 'Y') {
            $_559483616 = true;
        }
            ...
            if ($_698165198) {
                if (empty($_242162046) && ($_1634919591 == 1)) {
                    foreach ($_698165198 as $_451509742 => $_1146433095) {
                        if (($this->_1758607422['TYPE'] == 'advantshop') && ($_451509742 == $_417050936)) {
                            $_451509742 = str_replace('_', ':', $_451509742);
                        }
                        $_242162046[] = $_451509742;
                    }
                }
                if (($_1813127374 || $_1304313284 || $_559483616) && $this->_1758607422['TYPE'] != 'advantshop') {
                    $_1237891453[] = $_698165198;
                }
                $_1799584481 = $this->__1641660486($_7672767);
                if ($this->_1768427482 && ($this->_1758607422['USE_SKU'] == 'Y') && ($_1304313284 || $_277873286) && ($this->_2078735835[$_1799584481['IBLOCK_ID']])) {
                    ...
                    while ($_522409400 = $_1843558287->GetNextElement()) {
                        ...
                        if ($this->_1480025059 && $this->DemoCount()) {
                            break;
                        }
                    }
                    if ($this->_1480025059 && $this->DemoCount()) {
                ...
                if ($this->_1758607422['TYPE'] == 'advantshop') {
                    if ($this->_1758607422['XMLDATA'][$_417050936]['CONVERT_DATA_REGEXP'] == 'Y') {
                        if (!empty($this->_1758607422['XMLDATA'][$_417050936]['CONVERT_DATA'])) {
                            foreach ($this->_1758607422['XMLDATA'][$_417050936]['CONVERT_DATA'] as $_1304710919) {
        ...
        if ($_1634919591 == 1) {
            ...
            if (!$_3267963) {
                CDataExportproplusTools::ExportArrayMultiply($_1151979504, $_573539039);
            } else {
        ...
        foreach ($_1237891453 as $_1043885019) {
            ...
            if (!$_3267963) {
                ...
                CDataExportproplusTools::ExportArrayMultiply($_1116715160['ROWS'], $_573539039);
            }
        }
        if (!$_3267963) {
            ...
            if (is_array($_1116715160) && !empty($_1116715160)) {
                $_363010572 = $_SERVER['DOCUMENT_ROOT'] . $this->_1758607422['SETUP']['URL_DATA_FILE'];
                CDataExportproplusTools::ArrayToExcel($_363010572, $this->_1758607422['CODE'], $_1116715160, $this->_1758607422, $_1634919591);
            }
        }
    }
    ...
    {
        $_343599766 = DataExportproplusSession::GetAllSession($this->_1758607422["ID"]);
        $_1045937304 = 0;
        if (!empty($_343599766)) {
            foreach ($_343599766 as $_382622158) {
                $_1045937304 += $_382622158['EXPORTPROPLUS'][$this->_1758607422['ID']]['DEMO_COUNT'];
            }
        }
    ...
    public function ExportConvertCharset($_1639684675)
    {
        global $APPLICATION;
        $_464132572 = '';
        $_1136836731 = CDataExportproplusTools::GetStringCharset($_1639684675);
        $_464132572 = $APPLICATION->ConvertCharset($_1639684675, $_1136836731, $this->_1330835753[$this->_1758607422['ENCODING']]);
        return $_464132572;
    }
    ...
    {
        $_1603433907 = CDataExportproplusTools::GetProfileMarketCategoryType($this->_1758607422["TYPE"]);
        ...
        $_239173557 = (intval($_1461419195->_1235249829) > 0) ? $_1461419195->_1235249829 : ceil($_1461419195->SelectedRowsCount() / $this->_1418013741);
        $_243855875 = DataExportproplusSession::GetSession($this->_1758607422['ID']);
        $_243855875['EXPORTPROPLUS']['LOG'][$this->_1758607422['ID']]['STEPS'] = $_239173557;
        DataExportproplusSession::SetSession($this->_1758607422['ID'], $_243855875);
        $_1813127374 = false;
        $_1304313284 = false;
        $_277873286 = false;
        ...
        if ($_1461419195->SelectedRowsCount()) {
            if (($this->_1758607422['TYPE'] == 'vk_trade') && ($_1634919591 == 1)) {
            } elseif (($this->_1758607422['TYPE'] == 'ok_trade') && ($_1634919591 == 1)) {
                $this->_360787538->ClearSyncData();
            } elseif (($this->_1758607422['TYPE'] == 'instagram_trade') && ($_1634919591 == 1)) {
            }
        }
        if ($this->_2021795626) {
            $_1897180346 = 0;
        ...
        while ($_485935950 = $_1461419195->GetNextElement()) {
            $_111748978 = DataExportproplusSession::GetSession($this->_1758607422['ID']);
            if ($_341676656) {
                if (($_111748978['EXPORTPROPLUS']['LOG'][$this->_1758607422['ID']]['PRODUCTS_EXPORT'] >= ($_1897180346 + $this->_1758607422['SETUP']['CRON'][$_1478952812]['STEP_EXPORT_CNT'])) || ((intval($this->_1758607422['SETUP']['CRON'][$_1478952812]['MAXIMUM_PRODUCTS']) > 0) && ($_111748978['EXPORTPROPLUS']['LOG'][$this->_1758607422['ID']]['PRODUCTS_EXPORT'] >= $this->_1758607422['SETUP']['CRON'][$_1478952812]['MAXIMUM_PRODUCTS'])) || ($_1634919591 != 1)) {
                    break;
                }
            }
            ...
            if ($this->_1768427482 && ($this->_1758607422['USE_SKU'] == 'Y') && ($_277873286 || $_559483616)) {
                if (!$_1813127374 && !$_1304313284 && !$_559483616) {
                    $_1799584481 = $_485935950->GetFields();
                }
    ...
    public function ProcessVariantDataXML($_11678077, $_982944057)
    {
        if (is_array($_11678077) && !empty($_11678077)) {
            ...
            CDataExportproplusElement::OnBeforePropertiesSelect($_1892215348);
            $_315870870 = 0;
            foreach ($_11678077 as $_1489104411 => $_218875339) {
                ...
                foreach ($_218875339 as $_1659850986) {
                    ...
                    $_476275791 = $this->_1758607422['VARIANT']['SEX_CONST'] ? $this->_1758607422['VARIANT']['SEX_CONST'] : $_1799584481[$this->_831285158['SEX']];
                    $_706297844 = explode('-', $this->_1758607422['VARIANT']['CATEGORY'][$_982944057]);
                    $_522921858 = explode('-', $this->_1758607422['VARIANT']['CATEGORY_EXT'][$_982944057]);
                    ...
                    if ($_2013207294) {
                        $_476275791 = $this->_1758607422['VARIANT']['SEX_CONST'] ? $this->_1758607422['VARIANT']['SEX_CONST'] : $_1799584481[$this->_831285158['SEXOFFER']];
            ...
            if (($_315870870 == 0) && count($_1610311003)) {
                foreach ($_1610311003 as $_1552592902) {
                    CDataExportproplusExport::Save($_1552592902['XML']);
                    $this->_940439577->IncProductExport();
                }
            }
            unset($_11678077);
...
class CDataExportproplusComponent
{
    private static $_1086566520 = array("catalog" => "CDataExportproplusRemarketingCatalog", "catalog.element" => "CDataExportproplusRemarketingCatalogElement",);
    private static $_988540307 = array("catalog", "catalog.element");
    private $_56891786 = false;
    private $_1727880634 = false;
    private $_163633169 = false;
    private $_2106461800 = false;
    private $_926924184 = false;

    function __construct()
    {
        $this->_2106461800 = \CSite::GetSiteDocRoot(SITE_ID);
    }

    public function __1558491877()
    {
        if ($this->_1727880634 !== false) {
            global $APPLICATION;
            $_1086566520 = \PHPParser::ParseScript($APPLICATION->GetFileContent($this->_2106461800 . $this->_1727880634));
            foreach ($_1086566520 as $_1088962615) {
                list($_1892119997, $_1120866557) = explode(':', trim($_1088962615['DATA']['COMPONENT_NAME']));
                if (!in_array($_1120866557, static::$_988540307)) continue;
                $this->_56891786 = trim($_1088962615['DATA']['COMPONENT_NAME']);
                if (!empty($this->_163633169['DATA']['PARAMS'])) $_1088962615['DATA']['PARAMS'] = array_merge_recursive($_1088962615['DATA']['PARAMS'], $this->_163633169['DATA']['PARAMS']);
                $_1495904601 = $this->__1777700177($_1088962615);
                if (!$_1495904601) continue;
                $_602387488 = call_user_func(array($this->_926924184, 'execute'), $_1495904601);
                if (!$_602387488) continue;
                if (0 < $_602387488['params']['ELEMENT_ID']) return $_602387488;
            }
        }
        return false;
    }

    private function __1777700177($_1088962615)
    {
        list($_1892119997, $_1120866557) = explode(":", trim($this->_56891786));
        $_1809659998 = static::$_1086566520[$_1120866557];
        if (!class_exists($_1809659998)) {
            return false;
        }
        $this->_926924184 = static::$_1086566520[$_1120866557];
        $_1613356916 = new \CBitrixComponent();
        $_1613356916->initComponent($this->_56891786, $_1088962615['DATA']['TEMPLATE_NAME']);
        $_1613356916->_307966989 = $_1088962615['DATA']['PARAMS'];
        return $_1613356916;
    }

    public function setPath($_1636810295)
    {
        $this->_1727880634 = $_1636810295;
        return $this;
    }

    public function setData($_251862020)
    {
        $this->_163633169 = array("DATA" => array("TEMPLATE_NAME" => $_251862020["templateName"], "PARAMS" => $_251862020["params"]));
        return $this;
    }
}

class CDataExportproplusGoogleTagManager
{
    function OnEndBufferContent(&$_144979044)
    {
        if (\Bitrix\Main\Config\Option::get('data.exportproplus', 'disable_old_core') == 'Y') {
            return;
        }
        if (defined('ADMIN_SECTION') && (ADMIN_SECTION == true)) return;
        $_2097662443 = new CExportproplusProfileDB();
        $_1232139345 = $_2097662443->GetList(array(), array('ACTIVE' => 'Y', 'USE_GOOGLETAGMANAGER' => 'Y'));
        while ($_1879646551 = $_1232139345->Fetch()) {
            $_1866861386 = $_2097662443->GetByID($_1879646551['ID']);
            if (strlen(trim($_1866861386['GOOGLETAGMANAGER_ID'])) <= 0) {
                continue;
            }
            $_1812817065 = self::__534066358($_1866861386['LID']);
            if (!in_array($_SERVER['HTTP_HOST'], $_1812817065)) {
                continue;
            }
            $_1371146731 = self::__1491621891($_1866861386['GOOGLETAGMANAGER_ID']);
            foreach ($_1371146731 as $_1821569122 => $_2068321914) {
                if (!self::__1571929657($_1821569122, $_144979044)) {
                    $_144979044 = preg_replace('/(<' . $_1821569122 . '.*?>)/i', '$1' . PHP_EOL . $_2068321914, $_144979044);
                }
            }
        }
    }
...
class CDataExportproplusRemarketing
{
    private static function __1858180462($_1410062057)
    {
        $_1566762013 = array();
        foreach ($_1410062057 as $type) {
            $_7512881 = self::__44158263($type);
            if (!$_7512881) continue;
            $_1566762013[] = $_7512881;
        }
        return array_filter($_1566762013);
    }
    ...
    function OnEndBufferContent(&$_144979044)
    {
        ...
        $_1757943191 = array();
        $_2097662443 = new CExportproplusProfileDB();
        $_1232139345 = $_2097662443->GetList(array(), array('ACTIVE' => 'Y', 'USE_REMARKETING' => 'Y'));
        while ($_356755374 = $_1232139345->Fetch()) {
            if ($_1866861386 = $_2097662443->GetByID($_356755374['ID'])) {
                $_1757943191[$_1866861386['ID']] = $_1866861386;
            }
        }
        if (!count($_1757943191)) return;
        $_464132572 = self::__1558491877();
        if (!$_464132572) return;
        if ((!isset($_464132572['variables']['SECTION_ID']) || ($_464132572['variables']['SECTION_ID'] <= 0))) {
            $_590491089 = CIBlockElement::GetByID($_464132572['variables']['ELEMENT_ID']);
            if ($_485935950 = $_590491089->Fetch()) {
                $_464132572['variables']['SECTION_ID'] = $_485935950['IBLOCK_SECTION_ID'];
                $_464132572['params']['SECTION_ID'] = $_485935950['IBLOCK_SECTION_ID'];
            }
        }
        $_113297721 = array();
        foreach ($_1757943191 as $_1758607422) {
            self::__1899268852($_113297721, $_1758607422, $_464132572);
        }
        if (!count($_113297721)) return;
        $_133396353 = self::__1162863539($_113297721, $_464132572);
        ...
        if ($_363437152['html_tag']['position'] == 'before') {
            $_144979044 = str_replace('<' . $_697464525, $_133396353 . PHP_EOL . '<' . $_697464525, $_144979044);
        } elseif ($_363437152['html_tag']['position'] == 'after') {
            $_144979044 = str_replace($_697464525 . '>', $_697464525 . '>' . PHP_EOL . $_133396353, $_144979044);
        }
    }

    private static function __1558491877()
    {
        $_1443220763 = CDataExportproplusUrlRewrite::getInstance();
        $_1088962615 = new CDataExportproplusComponent();
        foreach ($_1443220763->getUrlRewrite() as $_11656276 => $_265020592) {
            if (($_13658018 = $_1443220763->getRuleByComponentId($_11656276)) !== false) {
                $_1088962615->setPath($_13658018['PATH']);
                $_464132572 = $_1088962615->__1558491877();
                if ($_464132572 !== false) return $_464132572;
            }
        }
        return false;
    }

    private static function __1899268852(&$_113297721, $_1758607422, $_464132572)
    {
        $_7512881 = self::__44158263($_1758607422["TYPE"]);
        if (!$_7512881) return false;
        $_1341799704 = array();
        if ($_1758607422['CHECK_INCLUDE'] != 'Y') $_2099964750 = CDataExportproplusTools::GetSectionNavChain($_464132572['variables']['SECTION_ID']);
        foreach ($_1758607422['CATEGORY'] as $_1754329594) {
            if ($_1758607422['CHECK_INCLUDE'] != 'Y') {
                if (in_array($_1754329594, $_2099964750)) {
                    if (in_array($_7512881, $_113297721)) continue;
                    $_113297721[] = $_7512881;
                }
            } elseif ($_1758607422['CHECK_INCLUDE'] == 'Y') {
                if ($_1754329594 == $_464132572['variables']['SECTION_ID']) {
                    if (in_array($_7512881, $_113297721)) continue;
                    $_113297721[] = $_7512881;
                }
            }
    ...
    private static function __44158263($type = null, $_1758607422 = null)
    {
        switch ($type) {
            case "google":
            case 'google_online':
    ...
    private static function __1162863539($_113297721, $_464132572)
    {
        $_1566762013 = "";
        $_1886524732 = array(
        ...
        $_1897466041 = GetModuleEvents('data.exportproplus', 'OnGetRemarketingTemplate');
        while ($_257451012 = $_1897466041->Fetch()) {
            ExecuteModuleEventEx($_257451012, array(&$_1886524732));
        }
        foreach ($_113297721 as $type) {
            if (array_key_exists($type, $_1886524732)) $_1566762013 .= str_replace(array('#ID#'), array($_464132572['params']['ELEMENT_ID']), $_1886524732[$type]) . PHP_EOL;
        }
        return $_1566762013;
    }
    ...
    private static function __836591764()
    {
        ...
        $_1897466041 = GetModuleEvents('data.exportproplus', 'OnGetRemarketingSettings');
        while ($_257451012 = $_1897466041->Fetch()) {
...
class CDataExportproplusRemarketingCatalog
{
    public static function __1558491877(\CBitrixComponent $_1088962615)
    {
        static::__onPrepareComponentParams($_1088962615->_307966989);
        $_464132572 = static::__component($_1088962615);
        return $_464132572;
    }
    ...
    protected static function __component(&$_1088962615)
    {
        if ($_1088962615->_307966989["SEF_MODE"] == "Y") $_464132572 = static::__1333554073($_1088962615); else $_464132572 = static::__823062964($_1088962615);
        if ($_464132572 !== false) {
            if ($_464132572['componentPage'] == 'element') {
                if ((!isset($_464132572['variables']['ELEMENT_ID']) || ($_464132572['variables']['ELEMENT_ID'] <= 0)) && strlen($_464132572['variables']['ELEMENT_CODE'])) {
                    $_262824078 = array('IBLOCK_ID' => $_1088962615->_307966989['IBLOCK_ID'], 'IBLOCK_LID' => SITE_ID, 'IBLOCK_ACTIVE' => 'Y', 'ACTIVE_DATE' => 'Y', 'CHECK_PERMISSIONS' => 'Y', 'MIN_PERMISSION' => 'R',);
                    if ($_1088962615->_307966989['SHOW_DEACTIVATED'] !== 'Y') $_262824078['ACTIVE'] = 'Y';
                    $_464132572['variables']['ELEMENT_ID'] = \CIBlockFindTools::GetElementID((isset($_464132572['variables']['ELEMENT_ID']) && strlen($_464132572['variables']['ELEMENT_ID'])) ? $_464132572['variables']['ELEMENT_ID'] : false, $_464132572['variables']['ELEMENT_CODE'], (isset($_464132572['variables']['SECTION_ID']) && strlen($_464132572['variables']['SECTION_ID'])) ? $_464132572['variables']['SECTION_ID'] : false, (isset($_464132572['variables']['SECTION_CODE']) && strlen($_464132572['variables']['SECTION_CODE'])) ? $_464132572['variables']['SECTION_CODE'] : false, $_262824078);
                }
                if (!isset($_464132572['variables']['ELEMENT_ID']) || ($_464132572['variables']['ELEMENT_ID'] <= 0)) return false;
                foreach ($_464132572['variables'] as $_370621247 => $_32014025) $_464132572['params'][$_370621247] = $_32014025;
            } else $_464132572 = false;
        }
        return $_464132572;
    }

    private static function __1333554073(&$_1088962615)
    {
        $_1389167078 = array();
        $_1135287693 = ($_1088962615->_307966989['SEF_URL_TEMPLATES']['section'] ? $_1088962615->_307966989['SEF_URL_TEMPLATES']['section'] : '#SECTION_ID#/');
        ...
        $_1702320177 = new \CComponentEngine($_1088962615);
        ...
        $_1296299244 = \CComponentEngine::MakeComponentUrlTemplates($_3627447, $_1088962615->_307966989['SEF_URL_TEMPLATES']);
        $_1822618101 = \CComponentEngine::MakeComponentVariableAliases($_536616350, $_1088962615->_307966989['VARIABLE_ALIASES']);
        $_1919784252 = Bitrix\Main\Context::getCurrent()->getRequest()->getRequestedPage();
        $_741011927 = substr($_1919784252, strlen($_1088962615->_307966989['SEF_FOLDER']));
        $_387837820 = array();
        ...
        if (array_key_exists('element', (is_array($_2110796054) ? $_2110796054 : array()))) {
            $_541863542 = $_1702320177->guessComponentPath($_1088962615->_307966989['SEF_FOLDER'], $_1296299244, $_1389167078);
            \CComponentEngine::InitComponentVariables($_541863542, $_112797755, $_1822618101, $_1389167078);
            return array('componentPage' => $_541863542, 'variables' => $_1389167078, 'params' => $_1088962615->_307966989);
        }
    }
    ...
    private static function __823062964(&$_1088962615)
    {
        $_1389167078 = array();
        $_531356295 = array();
        $_112797755 = array('SECTION_ID', 'SECTION_CODE', 'ELEMENT_ID', 'ELEMENT_CODE', 'action',);
        $_1822618101 = CComponentEngine::MakeComponentVariableAliases($_531356295, $_1088962615->_307966989['VARIABLE_ALIASES']);
...
class CDataExportproplusRemarketingCatalogElement
{
    public static function __1558491877(\CBitrixComponent $_1088962615)
    {
        static::__onPrepareComponentParams($_1088962615->_307966989);
    ...
    protected static function __component(&$_1088962615)
    {
        ...
        if ($_464132572 !== false) {
            if ($_464132572['componentPage'] == 'element') {
                if ((!isset($_464132572['variables']['ELEMENT_ID']) || ($_464132572['variables']['ELEMENT_ID'] <= 0)) && (strlen($_464132572['variables']['ELEMENT_CODE']) > 0)) {
                    $_262824078 = array('IBLOCK_ID' => $_1088962615->_307966989['IBLOCK_ID'], 'IBLOCK_LID' => SITE_ID, 'IBLOCK_ACTIVE' => 'Y', 'ACTIVE_DATE' => 'Y', 'CHECK_PERMISSIONS' => 'Y', 'MIN_PERMISSION' => 'R',);
                    if ($_1088962615->_307966989['SHOW_DEACTIVATED'] !== 'Y') $_262824078['ACTIVE'] = 'Y';
                    $_464132572['variables']['ELEMENT_ID'] = \CIBlockFindTools::GetElementID((isset($_464132572['variables']['ELEMENT_ID']) && strlen($_464132572['variables']['ELEMENT_ID'])) ? $_464132572['variables']['ELEMENT_ID'] : false, $_464132572['variables']['ELEMENT_CODE'], (isset($_464132572['variables']['SECTION_ID']) && strlen($_464132572['variables']['SECTION_ID'])) ? $_464132572['variables']['SECTION_ID'] : false, (isset($_464132572['variables']['SECTION_CODE']) && strlen($_464132572['variables']['SECTION_CODE'])) ? $_464132572['variables']['SECTION_CODE'] : false, $_262824078);
                }
...
class CDataExportproplusExternApiTools
{
    ...
    public function CurlPost($_1468923083, $_379606503, $_1104710553 = array())
    {
        ...
        $_1685438963 = '/upload/tmp/data.exportproplus/';
    ...
    {
        $_1436700053 = false;
        $_1436700053 = 'https://oauth.vk.com/authorize?client_id=' . GetMessage('DATA_VK_APPLICATION_ID') . '&scope=friends,wall,groups,offline,photos,video,market&redirect_uri=https://oauth.vk.com/blank.html&response_type=token&v=5.53&display=page';
        return $_1436700053;
    }
}

class CDataExportproplusVkModel
{
    public $_1758607422 = null;
    ...
    {
        $_1653488833 = array("ACCESS_TOKEN" => $this->_1758607422["VK"]["VK_ACCESS_TOKEN"], "GROUP_PUBLISH" => $this->_1758607422["VK"]["VK_GROUP_PUBLISH"], "USER_PUBLISH" => $this->_1758607422["VK"]["VK_USER_PUBLISH"], "API_VERSION" => ($this->_1758607422["SITE_PROTOCOL"] != "https") ? GetMessage("DATA_VK_API_HTTP_VERSION") : GetMessage('DATA_VK_API_HTTPS_VERSION'),);
        return $_1653488833;
    }

    public function GetAccountInfoData($_307966989 = false)
    {
        ...
        if (is_array($_307966989) && !empty($_307966989)) {
            foreach ($_307966989 as $_1025055810 => $_458660427) {
                $_379606503[$_1025055810] = $_458660427;
            }
        }
        $_2091273732 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1436700053, $_379606503, false), 1);
        return $_2091273732;
    }
    ...
    public function GetMarketCategories()
    {
        ...
        $_1710988751 = $APPLICATION->ConvertCharsetArray(json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1), 'UTF-8', SITE_CHARSET);
        return $_1710988751;
    }

    public function GetMarketItems($_307966989 = false)
    {
        global $APPLICATION;
        ...
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ALBUM_ID']) > 0)) {
            $_379606503['album_id'] = $_307966989['ALBUM_ID'];
        }
        $_1189272564 = $APPLICATION->ConvertCharsetArray(json_decode(CDataExportproplusExternApiTools::_CurlPost($_1436700053, $_379606503, false), 1), 'UTF-8', SITE_CHARSET);
        return $_1189272564;
    }
    ...
    {
        $_1238479422 = false;
        if (CDataExportproplusTools::ArrayValidate($_247886239)) {
            ...
            $_1238479422 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1);
        }
        return $_1238479422;
    }
    ...
    public function AddMarketItem($_887539035, $_477813228 = false)
    {
        ...
        if (is_array($_887539035) && !empty($_887539035)) {
            ...
            $_379606503['name'] = CDataExportproplusExternApiTools::PreparePostText($_887539035['NAME']);
            $_379606503['description'] = CDataExportproplusExternApiTools::PreparePostText($_887539035['URL_LABEL']) . '  ' . $this->_1758607422['SITE_PROTOCOL'] . '://' . $this->_1758607422['DOMAIN_NAME'] . $_887539035['URL'] . '

' . CDataExportproplusExternApiTools::PreparePostText($_887539035['DESCRIPTION']);
            ...
            $_1018740405 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_738250183, $_379606503, false), 1);
        }
        return $_1018740405;
    }
    ...
    public function SaveMarketPhoto($_1397337972, $_508350000 = false)
    {
        ...
        if (is_array($_1397337972) && !empty($_1397337972)) {
            ...
            $_1890170425 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_739831432, $_379606503, false), 1);
        }
        return $_1890170425;
    }
    ...
    public function PreparePhotoToSaveOnServer($_1397337972, $_508350000 = false, $_1687661643 = false, $_1065568205 = false, $_50240405 = false)
    {
        ...
        if (is_array($_1397337972) && !empty($_1397337972)) {
            ...
            if (is_array($_1397337972) && !empty($_1397337972)) {
                $_880503640 = array();
                if ($_1687661643) {
                    $_880503640['file'] = CDataExportproplusExternApiTools::GetCurlFilename($_1397337972[0]);
                } else {
                    if ($_1065568205) {
                        $_100730269 = 5;
                    } elseif ($_50240405) {
                    ...
                    foreach ($_1397337972 as $_1208095729 => $_1458548068) {
                        ...
                        $_880503640['file' . (count($_880503640) + 1)] = CDataExportproplusExternApiTools::GetCurlFilename($_1458548068);
                    }
                }
            }
            $_949254077 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_603413575, $_880503640, false), 1);
        }
        return $_949254077;
    }
    ...
    public function GetGroupUploadServerUrl($_1714541732)
    {
        ...
        if (intval($_1714541732) > 0) {
            ...
            $_898112218 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1);
        }
    ...
    public function GetMarketAlbumUploadServerUrl()
    {
        ...
        $_379606503['v'] = $this->_1745915131['API_VERSION'];
        $_379606503['group_id'] = $this->_1745915131['GROUP_PUBLISH'];
        $_967107132 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1436700053, $_379606503, false), 1);
    ...
    public function GetWallUploadServerUrl()
    {
        ...
        $_157382579 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1436700053, $_379606503, false), 1);
    ...
    public function GetMarketUploadServerUrl($_508350000 = false)
    {
        ...
        $_979286985 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1436700053, $_379606503, false), 1);
    ...
    public function DeleteMarketItem($_899073386)
    {
        ...
        if (intval($_899073386) > 0) {
            ...
            $_586559802 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_264741645, $_379606503, false), 1);
        }
        return $_586559802;
    }
    ...
    public function RestoreMarketItem($_899073386)
    {
        ...
        if (intval($_899073386) > 0) {
            ...
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['item_id'] = $_899073386;
            $_2091048150 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1599624494, $_379606503, false), 1);
        }
        return $_2091048150;
    }
    ...
    public function ReportMarketItem($_899073386, $_1693868533)
    {
        ...
        if ((intval($_899073386) > 0) && in_array($_1693868533, $_1928664118)) {
            ...
            $_95173523 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_624731944, $_379606503, false), 1);
        }
        return $_95173523;
    }

    public function ReorderMarketItems($_307966989)
    {
        $_868604444 = false;
        if (is_array($_307966989) && !empty($_307966989)) {
            ...
            $_379606503['v'] = $this->_1745915131['API_VERSION'];
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['item_id'] = $_307966989['ID'];
            if (intval($_307966989['ALBUM_ID']) > 0) {
                $_379606503['album_id'] = $_307966989['ALBUM_ID'];
            }
            if (intval($_307966989['BEFORE_ID']) > 0) {
                $_379606503['before'] = $_307966989['BEFORE_ID'];
            }
            if (intval($_307966989['AFTER_ID']) > 0) {
                $_379606503['after'] = $_307966989['AFTER_ID'];
            }
            $_868604444 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1113937798, $_379606503, false), 1);
        }
        return $_868604444;
    }

    public function AddMarketItemToAlbums($_307966989)
    {
        $_632882959 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0) && (strlen($_307966989['ALBUMS']) > 0)) {
            ...
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['item_id'] = $_307966989['ID'];
            $_379606503['album_ids'] = $_307966989['ALBUMS'];
            $_632882959 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_738250183, $_379606503, false), 1);
        }
        return $_632882959;
    }

    public function RemoveMarketItemFromAlbums($_307966989)
    {
        $_1891068344 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0) && (strlen($_307966989['ALBUMS']) > 0)) {
            ...
            $_379606503['item_id'] = $_307966989['ID'];
            $_379606503['album_ids'] = $_307966989['ALBUMS'];
            $_1891068344 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_716333439, $_379606503, false), 1);
        }
        return $_1891068344;
    }

    public function SearchMarketItems($_307966989)
    {
        $_2064361132 = false;
        if (is_array($_307966989) && !empty($_307966989)) {
            ...
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            if (intval($_307966989['ALBUM_ID']) > 0) {
                $_379606503['album_id'] = $_307966989['ALBUMS'];
            }
            if (strlen($_307966989['QUERY_STRING']) > 0) {
                $_379606503['q'] = $_307966989['QUERY_STRING'];
            }
            if (intval($_307966989['PRICE_FROM']) > 0) {
                $_379606503['price_from'] = $_307966989['PRICE_FROM'];
            }
            if (intval($_307966989['PRICE_TO']) > 0) {
                $_379606503['price_to'] = $_307966989['PRICE_TO'];
            }
            if (strlen($_307966989['TAGS']) > 0) {
                $_379606503['tags'] = $_307966989['TAGS'];
            }
            if ((intval($_307966989['SORT']) > 0) && in_array($_307966989['SORT'], $_1885788259)) {
                $_379606503['sort'] = $_307966989['SORT'];
            }
            if (!$_307966989['REV']) {
                $_379606503['rev'] = 0;
            }
            $_379606503['count'] = (intval($_307966989['COUNT']) > 0) ? $_307966989['COUNT'] : 100;
            if ($_307966989['EXTENDED']) {
                $_379606503['extended'] = 1;
            }
            $_2064361132 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_2060014154, $_379606503, false), 1);
        }
        return $_2064361132;
    }
    ...
    public function GetMarketAlbums()
    {
        ...
        $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
        $_379606503['count'] = 100;
        $_2073066713 = $APPLICATION->ConvertCharsetArray(json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1), 'UTF-8', SITE_CHARSET);
        return $_2073066713;
    }
    ...
    public function GetMarketAlbumsById($_417168712)
    {
        ...
        if (trim(strlen($_417168712)) > 0) {
            ...
            $_1356442790 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1);
        }
        return $_1356442790;
    }
    ...
    public function AddMarketAlbum($_790781857, $_263232621 = false, $_477813228 = false)
    {
        ...
        if (is_array($_790781857) && !empty($_790781857)) {
            ...
            $_379606503['title'] = CDataExportproplusExternApiTools::PreparePostText($_790781857['NAME']);
            ...
            $_278612349 = $APPLICATION->ConvertCharsetArray(json_decode(CDataExportproplusExternApiTools::_CurlPost($_738250183, $_379606503, false), 1), 'UTF-8', SITE_CHARSET);
        }
        return $_278612349;
    }
    ...
    public function SaveMarketAlbumPhoto($_1397337972)
    {
        ...
        if (is_array($_1397337972) && !empty($_1397337972)) {
            ...
            $_379606503['photo'] = $_1502272078['photo'];
            $_379606503['hash'] = $_1502272078['hash'];
            $_1510793760 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_739831432, $_379606503, false), 1);
        }
        return $_1510793760;
    }
    ...
    public function DeleteMarketAlbum($_1714541732, $_263232621 = false)
    {
        ...
        if (intval($_1714541732) > 0) {
            ...
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['album_id'] = $_1714541732;
            $_970468344 = $APPLICATION->ConvertCharsetArray(json_decode(CDataExportproplusExternApiTools::_CurlPost($_264741645, $_379606503, false), 1), 'UTF-8', SITE_CHARSET);
        }
        return $_970468344;
    }

    public function ReorderMarketAlbums($_307966989)
    {
        $_1991032056 = false;
        if (is_array($_307966989) && !empty($_307966989)) {
            ...
            $_379606503['v'] = $this->_1745915131['API_VERSION'];
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['album_id'] = $_307966989['ID'];
            if (intval($_307966989['BEFORE_ID']) > 0) {
                $_379606503['before'] = $_307966989['BEFORE_ID'];
            }
            if (intval($_307966989['AFTER_ID']) > 0) {
            ...
            $_1991032056 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1113937798, $_379606503, false), 1);
        }
        return $_1991032056;
    }

    public function GetGroupAlbums($_307966989 = false)
    {
        global $APPLICATION;
        ...
        $_379606503['v'] = $this->_1745915131['API_VERSION'];
        $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
        if (strlen($_307966989['ALBUMS']) > 0) {
            $_379606503['album_ids'] = $_307966989['ALBUMS'];
        }
        $_379606503['need_system'] = 0;
        $_379606503['need_covers'] = 1;
        $_379606503['photo_sizes'] = 1;
        $_183954103 = $APPLICATION->ConvertCharsetArray(json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1), 'UTF-8', SITE_CHARSET);
        return $_183954103;
    }
    ...
    public function GetGroupAlbumsCount()
    {
        ...
        $_379606503['v'] = $this->_1745915131['API_VERSION'];
        $_379606503['group_id'] = $this->_1745915131['GROUP_PUBLISH'];
        $_429611501 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1);
        return $_429611501;
    }

    public function CreateGroupAlbum($_307966989, $_477813228 = false)
    {
        $_600257380 = false;
        if (is_array($_307966989) && !empty($_307966989) && (strlen($_307966989['TITLE']) > 0) && (!$_477813228 || ($_477813228 && (intval($_307966989['ID']) > 0)))) {
            if ($_477813228) {
            ...
            $_379606503['title'] = CDataExportproplusExternApiTools::PreparePostText($_307966989['TITLE']);
            if (strlen($_307966989['DESCRIPTION']) > 0) {
                $_379606503['description'] = CDataExportproplusExternApiTools::PreparePostText($_307966989['DESCRIPTION']);
            }
            $_379606503['upload_by_admins_only'] = 1;
            $_379606503['comments_disabled'] = 0;
            $_600257380 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_129856824, $_379606503, false), 1);
        }
        return $_600257380;
    }

    public function DeleteGroupAlbum($_307966989)
    {
        $_557913179 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0)) {
            ...
            $_379606503['group_id'] = $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['album_id'] = $_307966989['ID'];
            $_557913179 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_264741645, $_379606503, false), 1);
        }
        return $_557913179;
    }

    public function ReorderGroupAlbums($_307966989)
    {
        $_463191136 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0)) {
            ...
            $_463191136 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1113937798, $_379606503, false), 1);
        }
        return $_463191136;
    }

    public function GetGroupPhotos($_307966989)
    {
        $_1812312156 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ALBUM_ID']) > 0)) {
            ...
            $_379606503['photo_sizes'] = 1;
            $_379606503['count'] = 100;
            $_1812312156 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1);
        }
        return $_1812312156;
    }

    public function GetGroupPhotosById($_307966989)
    {
        $_947784707 = false;
        if (is_array($_307966989) && !empty($_307966989) && (strlen($_307966989['PHOTOS']) > 0)) {
            $_1255633473 = 'https://api.vk.com/method/photos.getById';
            $_379606503 = array();
            $_379606503['access_token'] = $this->_1745915131['ACCESS_TOKEN'];
            $_379606503['v'] = $this->_1745915131['API_VERSION'];
            $_379606503['photos'] = $_307966989['PHOTOS'];
            if ($_307966989['EXTENDED']) {
                $_379606503['extended'] = 1;
            }
            $_379606503['photo_sizes'] = 1;
            $_947784707 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1);
        }
        return $_947784707;
    }

    public function AddGroupPhoto($_307966989)
    {
        $_990661420 = false;
        if (is_array($_307966989) && !empty($_307966989) && is_array($_307966989['FILES']) && !empty($_307966989['FILES']) && (strlen($_307966989['ALBUM_ID']) > 0)) {
            $_739831432 = 'https://api.vk.com/method/photos.save';
            $_990661420 = array();
            foreach ($_307966989['FILES'] as $_842953512) {
                $_1502272078 = self::PreparePhotoToSaveOnServer($_842953512['PHOTO'], false, false, $_307966989['ALBUM_ID']);
                $_379606503 = array();
                $_379606503['access_token'] = $this->_1745915131['ACCESS_TOKEN'];
                $_379606503['v'] = $this->_1745915131['API_VERSION'];
                $_379606503['group_id'] = $this->_1745915131['GROUP_PUBLISH'];
                ...
                $_379606503['hash'] = $_1502272078['hash'];
                $_379606503['caption'] = CDataExportproplusExternApiTools::PreparePostText($_307966989['URL_LABEL']) . $this->_1758607422['SITE_PROTOCOL'] . '://' . $this->_1758607422['DOMAIN_NAME'] . $_842953512['URL'] . '

' . CDataExportproplusExternApiTools::PreparePostText($_842953512['DESCRIPTION']);
                $_990661420[] = json_decode(CDataExportproplusExternApiTools::_CurlPost($_739831432, $_379606503, false), 1);
            }
        }
        return $_990661420;
    }

    public function EditGroupPhoto($_307966989)
    {
        $_2043565954 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0)) {
            ...
            $_379606503['v'] = $this->_1745915131['API_VERSION'];
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['photo_id'] = $_307966989['ID'];
            $_379606503['caption'] = CDataExportproplusExternApiTools::PreparePostText($_307966989['URL_LABEL']) . $this->_1758607422['SITE_PROTOCOL'] . '://' . $this->_1758607422['DOMAIN_NAME'] . $_307966989['URL'] . '

' . CDataExportproplusExternApiTools::PreparePostText($_307966989['DESCRIPTION']);
            $_2043565954 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_142408493, $_379606503, false), 1);
        }
        return $_2043565954;
    }

    public function DeleteGroupPhoto($_307966989)
    {
        $_884425807 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0)) {
            ...
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['photo_id'] = $_307966989['ID'];
            $_884425807 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_264741645, $_379606503, false), 1);
        }
        return $_884425807;
    }

    public function RestoreGroupPhoto($_307966989)
    {
        $_984819152 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0)) {
            ...
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['photo_id'] = $_307966989['ID'];
            $_984819152 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1599624494, $_379606503, false), 1);
        }
        return $_984819152;
    }

    public function MakeCoverGroupPhoto($_307966989)
    {
        $_1023429292 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0) && (intval($_307966989['ALBUM_ID']) > 0)) {
            ...
            $_379606503['photo_id'] = $_307966989['ID'];
            $_379606503['album_id'] = $_307966989['ALBUM_ID'];
            $_1023429292 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1546025225, $_379606503, false), 1);
        }
        return $_1023429292;
    }

    public function MoveGroupPhoto($_307966989)
    {
        $_1407734428 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0) && (intval($_307966989['ALBUM_ID']) > 0)) {
            ...
            $_379606503['owner_id'] = ((intval($this->_1745915131['GROUP_PUBLISH']) > 0) ? '-' : '') . $this->_1745915131['GROUP_PUBLISH'];
            $_379606503['photo_id'] = $_307966989['ID'];
            $_379606503['target_album_id'] = $_307966989['ALBUM_ID'];
            $_1407734428 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_627343393, $_379606503, false), 1);
        }
        return $_1407734428;
    }

    public function ReorderGroupPhotosInAlbum($_307966989)
    {
        $_1882570208 = false;
        if (is_array($_307966989) && !empty($_307966989) && (intval($_307966989['ID']) > 0)) {
            ...
            $_1882570208 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1113937798, $_379606503, false), 1);
        }
        return $_1882570208;
    }

    public function SearchGroupPhotos($_307966989)
    {
        global $APPLICATION;
        $_468740201 = false;
        if (is_array($_307966989) && !empty($_307966989) && (strlen($_307966989['QUERY_STRING']) > 0)) {
            ...
            $_379606503['q'] = $_307966989['QUERY_STRING'];
            $_379606503['sort'] = 0;
            $_468740201 = $APPLICATION->ConvertCharsetArray(json_decode(CDataExportproplusExternApiTools::_CurlPost($_2060014154, $_379606503, false), 1), 'UTF-8', SITE_CHARSET);
        }
        return $_468740201;
    }
    ...
    public function GetWallItemsById($_247886239, $_1547297743 = false)
    {
        ...
        $_369064949 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_1255633473, $_379606503, false), 1);
        return $_369064949;
    }
    ...
    public function AddWallItem($_887539035, $_477813228 = false)
    {
        ...
        if (is_array($_887539035) && !empty($_887539035)) {
            ...
            $_379606503['message'] = CDataExportproplusExternApiTools::PreparePostText($_887539035['URL_LABEL']) . $this->_1758607422['SITE_PROTOCOL'] . '://' . $this->_1758607422['DOMAIN_NAME'] . $_887539035['URL'] . '

' . CDataExportproplusExternApiTools::PreparePostText($_887539035['DESCRIPTION']);
            $_379606503['attachments'] = $_1392279748;
            $_111955992 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_738250183, $_379606503, false), 1);
        }
        return $_111955992;
    }
    ...
    public function SaveWallPhoto($_1397337972)
    {
        ...
        if (is_array($_1397337972) && !empty($_1397337972)) {
            ...
            $_379606503['photo'] = $_1502272078['photo'];
            $_379606503['hash'] = $_1502272078['hash'];
            $_1656004154 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_739831432, $_379606503, false), 1);
        }
        return $_1656004154;
    }
    ...
    public function DeleteWallItem($_899073386)
    {
        ...
        if (intval($_899073386) > 0) {
            ...
            $_1432791014 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_264741645, $_379606503, false), 1);
        }
        return $_1432791014;
    }
}

class CDataExportproplusFb
{
    public $_1758607422 = null;
    public $_1046076681 = null;
    public $_940439577;
    public $_1232139345 = null;
    ...
    public function GetAccessAccountData()
    {
        $_1653488833 = array("PAGE_PUBLISH" => $this->_1758607422["FB"]["FB_PAGE_PUBLISH"], "APP_ID" => $this->_1758607422["FB"]["FB_APP_ID"], "APP_SECRET" => $this->_1758607422["FB"]["FB_APP_SECRET"], "ACCESS_TOKEN" => $this->_1758607422["FB"]["FB_ACCESS_TOKEN"],);
        return $_1653488833;
    }
    ...
    function CheckDataAndAccess($_421487420, $_1811205380)
    {
        $_1126599918 = false;
        try {
            $_464132572 = $_1811205380->get('/' . $this->_1046076681['PAGE_PUBLISH'] . '?fields=access_token')->getGraphObject()->asArray();
            if (isset($_464132572['access_token'])) {
                $_1811205380->setDefaultAccessToken($_464132572['access_token']);
                $_1126599918 = true;
            }
        } catch (Facebook\Exceptions\FacebookResponseException $_730210266) {
            $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#FB_ERROR#', 'CODE: ' . $_730210266, GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_FB_SKIP')));
            $this->_940439577->IncProductError();
    ...
    function ProcessData($_421487420)
    {
        ...
        $_852380599 = $this->_1758607422['FB']['FB_RELATIONS'];
        $_1404128509 = false;
        if ($this->_1758607422['FB']['FB_RELATIONS'] != null) {
        ...
        if ($_1404128509) {
            ...
            if ($this->_1758607422['FB']['FB_RELATIONS'] == null) {
                $this->_1758607422['FB']['FB_RELATIONS'] = array();
            }
            try {
                $_683024549 = $_1389222250->post('/' . $this->_1046076681['PAGE_PUBLISH'] . '/feed', $_144497832)->getDecodedBody();
                $this->_1758607422['FB']['FB_RELATIONS'][$_421487420['ID']] = $_683024549['id'];
                $this->_1232139345->Update($this->_1758607422['ID'], $this->_1758607422);
            } catch (Facebook\Exceptions\FacebookResponseException $_730210266) {
                $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#FB_ERROR#', 'CODE: ' . $_730210266, GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_FB_SKIP')));
                $this->_940439577->IncProductError();
...
class CDataExportproplusOk
{
    ...
    public function GetAccessAccountData()
    {
        $_1653488833 = array("IS_GROUP_PUBLISH" => $this->_1758607422["OK"]["OK_IS_GROUP_PUBLISH"], "GROUP" => $this->_1758607422["OK"]["OK_GROUP"], "APP_ID" => $this->_1758607422["OK"]["OK_APP_ID"], "APP_PUBLIC_KEY" => $this->_1758607422["OK"]["OK_APP_PUBLIC_KEY"], "APP_SECRET_KEY" => $this->_1758607422["OK"]["OK_APP_SECRET_KEY"], "ACCESS_TOKEN" => $this->_1758607422["OK"]["OK_ACCESS_TOKEN"],);
        return $_1653488833;
    }
    ...
    function AddMediatopic($_421487420)
    {
        ...
        if (isset($_1680932907['error_code'])) {
            $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_1680932907['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
            $this->_940439577->IncProductError();
        }
        return $_1680932907;
    }
    ...
    function PreparePostData($_421487420)
    {
        ...
        $_379606503['link'] = $_421487420['URL'];
        $_379606503['picture'] = $_421487420['PHOTO'];
        $_379606503['name'] = CDataExportproplusExternApiTools::PreparePostText($_421487420['NAME'], 'UTF-8');
        $_379606503['description'] = CDataExportproplusExternApiTools::PreparePostText($_421487420['DESCRIPTION'], 'UTF-8');
        $_379606503['description_market'] = CDataExportproplusExternApiTools::PreparePostText($_421487420['DESCRIPTION_MARKET'], 'UTF-8');
        $_379606503['price'] = CDataExportproplusExternApiTools::PreparePostText($_421487420['PRICE'], 'UTF-8');
        $_379606503['currency'] = CDataExportproplusExternApiTools::PreparePostText($_421487420['CURRENCY'], 'UTF-8');
        return $_379606503;
    }
    ...
    function UploadPhotos($_1292708158, $_1977694378 = false)
    {
        ...
        if (!isset($_203114691['error_code'])) {
            ...
            foreach ($_1292708158 as $_1392445933 => $_805262176) {
                $_664551201['pic' . $_1392445933] = CDataExportproplusExternApiTools::GetCurlFilename($_805262176);
            }
            $_1966182546 = json_decode(CDataExportproplusExternApiTools::_CurlPost($_203114691['upload_url'], $_664551201));
    ...
    function DeleteMediaTopicById($_138792169)
    {
        ...
        if (!isset($_1062111222['error_code'])) {
            ...
            if (isset($_697577572['error_code'])) {
                $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_697577572['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
                $this->_940439577->IncProductError();
            }
        }
        return $_697577572;
    ...
    function GetMediaTopicById($_138792169)
    {
        ...
        if (isset($_1606303299['error_code'])) {
            $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_1606303299['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
            $this->_940439577->IncProductError();
        }
        return $_1606303299;
    }
    ...
    function DeleteMediaTopic($_1572082177)
    {
        ...
        if (isset($_85688229['error_code'])) {
            $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_85688229['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
            $this->_940439577->IncProductError();
        }
        return $_85688229;
    }
    ...
    {
        $_1933377560 = false;
        $_1892336024 = array('gid' => $this->_1120395184['GROUP'], 'title' => CDataExportproplusExternApiTools::PreparePostText($_421487420['NAME'], 'UTF-8'));
        $_1933377560 = \OdnoklassnikiSDK::makeRequest('photos.createAlbum', $_1892336024);
        if (isset($_1933377560['error_code'])) {
            $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_1933377560['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
            $this->_940439577->IncProductError();
        }
        return $_1933377560;
    }
    ...
    function DeleteAlbum($_421487420)
    {
        ...
        if (isset($_624484612['error_code'])) {
            $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_624484612['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
            $this->_940439577->IncProductError();
        }
        return $_624484612;
    }
    ...
    {
        $_82116745 = false;
        $_1892336024 = array('photo_id' => $_421487420['ID'], 'token' => $_421487420['TOKEN'], 'comment' => CDataExportproplusExternApiTools::PreparePostText($_421487420['DESCRIPTION'], 'UTF-8'));
    ...
    function AddMarketItem($_421487420, $_477813228 = false)
    {
        ...
        if (isset($_1939043974['error_code'])) {
            $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_1939043974['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
            $this->_940439577->IncProductError();
        }
        return $_1939043974;
    }
    ...
    function DeleteMarketItem($_1468334516)
    {
        ...
        if (isset($_586559802['error_code'])) {
            $this->_940439577->AddMessage("(ID:{$_1468334516}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_586559802['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
            $this->_940439577->IncProductError();
        }
        return $_586559802;
    }
    ...
    function AddMarketCatalog($_421487420, $_477813228 = false)
    {
        ...
        $_1892336024 = array('gid' => $this->_1120395184['GROUP'], 'name' => CDataExportproplusExternApiTools::PreparePostText($_421487420['NAME'], 'UTF-8'), 'photo_id' => $_538866776['id'],);
        if ($_477813228) {
        ...
        if (isset($_292098795['error_code'])) {
            $this->_940439577->AddMessage("{$_421487420['NAME']} (ID:{$_421487420['ID']}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_292098795['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
            $this->_940439577->IncProductError();
        }
        return $_292098795;
    }
    ...
    function DeleteMarketCatalog($_1927656670, $_1453040935 = false)
    {
        ...
        if (isset($_577061498['error_code'])) {
            $this->_940439577->AddMessage("(ID:{$_1927656670}) : " . str_replace('#OK_ERROR#', 'CODE: ' . $_577061498['error_msg'], GetMessage('DATA_EXPORTPROPLUS_REQUIRED_FIELD_OK_SKIP')));
            $this->_940439577->IncProductError();
        }
        return $_577061498;
    }
...
class CDataExportproplusInstagram
{
    public $_1758607422 = null;
    ...
    public function GetAccessAccountData()
    {
        $_1653488833 = array("LOGIN" => $this->_1758607422["INSTAGRAM"]["INSTAGRAM_LOGIN"], "PASSWORD" => $this->_1758607422["INSTAGRAM"]["INSTAGRAM_PASSWORD"],);
        return $_1653488833;
    }
        ...
        if (((strlen($_421487420['PHOTO']) > 0) || $_632876101) && (strlen($_421487420['DESCRIPTION']) > 0) && self::Login()) {
            if ($_632876101) {
                ...
                foreach ($_421487420['PHOTO'] as $_1819348880) {
                    ...
                    $_251862020 = self::GetPostData($_1819348880);
                    $_303541024[] = self::ApiMethod('media/upload/', $_251862020, 3);
                }
                $_1913374605 = array();
                ...
                if (is_array($_1913374605) && !empty($_1913374605)) {
                    ...
                    $_1155109198 = CDataExportproplusTools::GetStringCharset($_421487420['DESCRIPTION']);
                    if ($_1155109198 == 'cp1251') {
                        $_421487420['DESCRIPTION'] = $GLOBALS['APPLICATION']->ConvertCharset($_421487420['DESCRIPTION'], 'windows-1251', 'UTF-8');
                    }
                    $_251862020 = (object)array('device_id' => $this->_27821683, 'guid' => $this->_685758188, 'media_id' => $_1913374605[0], 'caption' => html_entity_decode(trim($_421487420['DESCRIPTION'])), 'device_timestamp' => time(), 'source_type' => '5', 'filter_type' => '0', 'extra' => '{}', 'Content-Type' => 'application/x-www-form-urlencoded; charset=UTF-8',);
                    $_251862020 = json_encode($_251862020);
                    $_471527411 = self::GenerateSignature($_251862020);
                    $_327967743 = 'signed_body=' . $_471527411 . '.' . urlencode($_251862020) . '&ig_sig_key_version=4';
                    $_1548575078 = self::ApiMethod('media/configure/', $_327967743, 3);
                }
            } else {
                $_421487420['PHOTO'] = self::GetSquareImage($_421487420['PHOTO']);
                $_251862020 = self::GetPostData($_421487420['PHOTO']);
                $_1964409291 = self::ApiMethod('media/upload/', $_251862020, 3);
                if (empty($_1964409291)) {
                    $_1436318387 = 'Empty response received from the server while trying to post the image';
                } else {
                    $_2137625708 = @json_decode($_1964409291, true);
                    if (empty($_2137625708)) {
                        ...
                        if ($_479845416 != 'ok') {
                            ...
                            $_251862020 = (object)array('device_id' => $this->_27821683, 'guid' => $this->_685758188, 'media_id' => $_1772650701, 'caption' => html_entity_decode(trim($_421487420['DESCRIPTION'])), 'device_timestamp' => time(), 'source_type' => '5', 'filter_type' => '0', 'extra' => '{}', 'Content-Type' => 'application/x-www-form-urlencoded; charset=UTF-8',);
                            $_251862020 = json_encode($_251862020);
                            $_471527411 = self::GenerateSignature($_251862020);
                            $_327967743 = 'signed_body=' . $_471527411 . '.' . urlencode($_251862020) . '&ig_sig_key_version=4';
                            $_1548575078 = self::ApiMethod('media/configure/', $_327967743, 3);
    ...
    {
        $_555782255 = true;
        $_251862020 = ( object )array('device_id' => $this->_27821683, 'guid' => $this->_685758188, 'username' => $this->_1730079280['LOGIN'], 'password' => $this->_1730079280['PASSWORD'], 'Content-Type' => 'application/x-www-form-urlencoded; charset=UTF-8',);
        $_251862020 = json_encode($_251862020);
        $_471527411 = self::GenerateSignature($_251862020);
        $_251862020 = 'signed_body=' . $_471527411 . '.' . urlencode($_251862020) . '&ig_sig_key_version=4';
        $_1492428343 = self::ApiMethod('accounts/login/', $_251862020, 2);
    ...
    function GenerateSignature($_251862020)
    {
        return hash_hmac('sha256', $_251862020, 'b4a23f5e39b5929e0666ac5de94c89d1618a2916');
    }

    public function ApiMethod($_1604926397, $_251862020, $_1156711538)
    {
        $_1566762013 = false;
        if ($_1604926397 != '') {
            $_1468923083 = 'https://instagram.com/api/v1/' . $_1604926397;
            $_1566762013 = self::_curl_post($_1468923083, $_251862020, array($_1156711538, 'instagram'), self::GenerateUserAgent());
        }
        return $_1566762013;
    }
    ...
    function curl_post($_1468923083, $_185069423, $_1104710553 = array())
    {
        ...
        $_1213592343 = $_SERVER['DOCUMENT_ROOT'] . '/upload/data.exportproplus/';
    ...
    {
        return $_SERVER['DOCUMENT_ROOT'] . '/upload/tmp/data.exportproplus.instagram.image.tmp.jpg';
    }
    ...
    function GetPostData($_2120721791)
    {
        if (!$_2120721791) {
            ...
            $_185069423 = array('device_timestamp' => time(), 'photo' => CDataExportproplusExternApiTools::GetCurlFilename($_2120721791));
            return $_185069423;
        }
    }
    ...
    public function UpdatePhoto($_421487420)
    {
        ...
        if ((intval($_421487420['POST_ID']) > 0) && (strlen($_421487420['DESCRIPTION']) > 0) && self::Login()) {
            ...
            $_251862020 = ( object )array('device_id' => $this->_27821683, 'guid' => $this->_685758188, 'caption_text' => html_entity_decode(trim($_421487420['DESCRIPTION'])), 'device_timestamp' => time(), 'Content-Type' => 'application/x-www-form-urlencoded; charset=UTF-8',);
            $_251862020 = json_encode($_251862020);
            $_471527411 = self::GenerateSignature($_251862020);
            $_251862020 = 'signed_body=' . $_471527411 . '.' . urlencode($_251862020) . '&ig_sig_key_version=4';
            $_2005030324 = self::ApiMethod('media/' . $_421487420['POST_ID'] . '/edit_media/', $_251862020, 3);
        }
        return $_2005030324;
    }
    ...
    public function DeletePhoto($_421487420)
    {
        ...
        if ((intval($_421487420['POST_ID']) > 0) && self::Login()) {
            $_251862020 = ( object )array('device_id' => $this->_27821683, 'guid' => $this->_685758188, 'media_id' => $_421487420['POST_ID'], 'device_timestamp' => time(), 'Content-Type' => 'application/x-www-form-urlencoded; charset=UTF-8',);
            $_251862020 = json_encode($_251862020);
            $_471527411 = self::GenerateSignature($_251862020);
            $_251862020 = 'signed_body=' . $_471527411 . '.' . urlencode($_251862020) . '&ig_sig_key_version=4';
            $_761849752 = self::ApiMethod('media/' . $_421487420['POST_ID'] . '/delete/?media_type=1', $_251862020, 3);
        }
        return $_761849752;
    }
}
